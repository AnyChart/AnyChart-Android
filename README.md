...
Add the dependency:
```clojure
:dependencies [[com.github.AnyChart/AnyChart-Android "0.0.9"]]
```
...
Add the dependency:
```sbt
libraryDependencies += "com.github.AnyChart" % "AnyChart-Android" % "0.0.9"
```
...
```Groovy
dependencies {
        compile 'com.github.AnyChart:AnyChart-Android:0.0.9'
}
```
