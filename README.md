...
Add the dependency:
```clojure
:dependencies [[com.github.AnyChart/AnyChart-Android "0.1.3"]]
```
...
Add the dependency:
```sbt
libraryDependencies += "com.github.AnyChart" % "AnyChart-Android" % "0.1.3"
```
...
```Groovy
dependencies {
        compile 'com.github.AnyChart:AnyChart-Android:0.1.3'
}
```
