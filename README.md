...
Add the dependency:
```clojure
:dependencies [[com.github.AnyChart/AnyChart-Android "0.2.6"]]
```
...
Add the dependency:
```sbt
libraryDependencies += "com.github.AnyChart" % "AnyChart-Android" % "0.2.6"
```
...
```Groovy
dependencies {
        compile 'com.github.AnyChart:AnyChart-Android:0.2.6'
}
```
