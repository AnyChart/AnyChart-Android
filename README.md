...
Add the dependency:
```clojure
:dependencies [[com.github.AnyChart/AnyChart-Android "0.1.0"]]
```
...
Add the dependency:
```sbt
libraryDependencies += "com.github.AnyChart" % "AnyChart-Android" % "0.1.0"
```
...
```Groovy
dependencies {
        compile 'com.github.AnyChart:AnyChart-Android:0.1.0'
}
```
