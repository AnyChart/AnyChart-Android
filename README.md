...
Add the dependency:
```clojure
:dependencies [[com.github.AnyChart/AnyChart-Android "0.0.8"]]
```
...
Add the dependency:
```sbt
libraryDependencies += "com.github.AnyChart" % "AnyChart-Android" % "0.0.8"
```
...
```Groovy
dependencies {
        compile 'com.github.AnyChart:AnyChart-Android:0.0.8'
}
```
