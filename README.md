...
Add the dependency:
```clojure
:dependencies [[com.github.AnyChart/AnyChart-Android "0.1.7"]]
```
...
Add the dependency:
```sbt
libraryDependencies += "com.github.AnyChart" % "AnyChart-Android" % "0.1.7"
```
...
```Groovy
dependencies {
        compile 'com.github.AnyChart:AnyChart-Android:0.1.7'
}
```
