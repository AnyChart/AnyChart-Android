...
Add the dependency:
```clojure
:dependencies [[com.github.AnyChart/AnyChart-Android "0.1.5"]]
```
...
Add the dependency:
```sbt
libraryDependencies += "com.github.AnyChart" % "AnyChart-Android" % "0.1.5"
```
...
```Groovy
dependencies {
        compile 'com.github.AnyChart:AnyChart-Android:0.1.5'
}
```
