...
//        circularGauge.setData(new String[] { "23", "34", "67", "93", "56", "100" }, TextParsingMode.CSV);
        ...
        circularGauge.getLabel(1d)
                .setText("Guaifenesin, <span style=\"\">34%</span>")
                .setUseHtml(true)
                .setHAlign(TextHAlign.CENTER)
                .setVAlign(TextVAlign.MIDDLE);
        circularGauge.getLabel(1d)
        ...
        circularGauge.getLabel(2d)
                .setText("Salicylic Acid, <span style=\"\">67%</span>")
                .setUseHtml(true)
                .setHAlign(TextHAlign.CENTER)
                .setVAlign(TextVAlign.MIDDLE);
        circularGauge.getLabel(2d)
        ...
        circularGauge.getLabel(3d)
                .setText("Fluoride, <span style=\"\">93%</span>")
                .setUseHtml(true)
                .setHAlign(TextHAlign.CENTER)
                .setVAlign(TextVAlign.MIDDLE);
        circularGauge.getLabel(3d)
        ...
        circularGauge.getLabel(4d)
                .setText("Zinc Oxide, <span style=\"\">56%</span>")
                .setUseHtml(true)
                .setHAlign(TextHAlign.CENTER)
                .setVAlign(TextVAlign.MIDDLE);
        circularGauge.getLabel(4d)
