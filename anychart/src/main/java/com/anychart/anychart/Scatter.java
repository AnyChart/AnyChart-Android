...
<b>Note:</b> Works only after {@link anychart.charts.Scatter#draw} is called.
     ...
     */
    public Scatter setMaxLabels(String settings) {
        if (!isChain) {
            js.append(jsBase);
            isChain = true;
        }
     ...
     * Setter for maximum labels.
     */
    public Scatter setMaxLabels(Boolean settings1) {
        if (!isChain) {
            js.append(jsBase);
            isChain = true;
        }
     ...
     */
    public Scatter setMinLabels(String settings2) {
        if (!isChain) {
            js.append(jsBase);
            isChain = true;
        }
     ...
     * Setter for minimum labels.
     */
    public Scatter setMinLabels(Boolean settings3) {
        if (!isChain) {
            js.append(jsBase);
            isChain = true;
        }
