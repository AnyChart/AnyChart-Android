...
public class Context extends JsObject  {
    ...
    public Context(Double adxAlpha, Double adxPeriod, CycledQueue adxQueue, Double adxValue, Double alpha, CycledQueue closeQueue, CycledQueue highQueue, CycledQueue lowQueue, Double ndiSumValue, Double ndiValue, Double pdiSumValue, Double pdiValue, Double period, Double trSumValue, Boolean useWildersSmoothing) {
