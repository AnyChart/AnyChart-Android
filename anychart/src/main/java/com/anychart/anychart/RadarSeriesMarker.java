...
// class
public class RadarSeriesMarker extends RadarSeriesBase {

    private String jsBase;

    public RadarSeriesMarker() {

    }

    protected RadarSeriesMarker(String jsBase) {
        this.jsBase = jsBase;
    }
    ...
    public void setMeta(String key2) {
        if (jsBase == null) {
            this.key = null;
            this.key1 = null;
            this.key2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".meta(%s);", key2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".meta(%s);", key2));
                js.setLength(0);
            }
        }
    }
    ...
    public void setUnlistenbykey(String key3) {
        if (jsBase == null) {
            this.key = null;
            this.key1 = null;
            this.key2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".unlistenByKey(%s);", key3));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".unlistenByKey(%s);", key3));
                js.setLength(0);
            }
        }
    }
    ...
    private String generateJSxSubRangeRatio() {
        if (xSubRangeRatio != null) {
            return String.format(Locale.US, "xSubRangeRatio: %f,", xSubRangeRatio);
        }
        return "";
    }
    ...
    protected String generateJs() {
        if (jsBase == null) {
            ...
            js.append(generateJSxSubRangeRatio());
