...
public class StandalonesScroller extends UiScroller {
    ...
    public void setEndratio(Double endRatio) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".endRatio(%f);", endRatio));
    ...
    public void setSetrange(Double startRatio, Double endRatio1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".setRange(%f, %f);", startRatio, endRatio1));
    ...
    public void setStartratio(Double startRatio1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".startRatio(%f);", startRatio1));
