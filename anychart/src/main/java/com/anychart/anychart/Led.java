...
// class
public class Led extends JsObject {
    ...
    public void setGap(String gap1) {
        if (jsBase == null) {
            this.gap = null;
            this.gap1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".gap(%s);", gap1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".gap(%s);", gap1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSize(String size4) {
        if (jsBase == null) {
            this.size = null;
            this.size1 = null;
            this.size2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".size(%s);", size4));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".size(%s);", size4));
                js.setLength(0);
            }
        }
    }
