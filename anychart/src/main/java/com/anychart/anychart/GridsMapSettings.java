...
// class
public class GridsMapSettings extends JsObject {
    ...
    public void setHorizontal(Boolean horizontal) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".horizontal(%b);", horizontal));
    ...
    public void setHorizontal(String horizontal1) {
        if (jsBase == null) {
            this.horizontal = null;
            this.horizontal1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".horizontal(%s);", horizontal1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".horizontal(%s);", horizontal1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setVertical(Boolean vertical) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".vertical(%b);", vertical));
    ...
    public void setVertical(String vertical1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".vertical(%s);", vertical1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".vertical(%s);", vertical1));
                js.setLength(0);
            }
        }
    }
    ...
    private String generateJShorizontal() {
        if (horizontal != null) {
            return String.format(Locale.US, "horizontal: %b,", horizontal);
        }
        return "";
    }

    private String generateJShorizontal1() {
        if (horizontal1 != null) {
            return String.format(Locale.US, "horizontal: %s,", horizontal1);
        }
        return "";
    }
    ...
    private String generateJSvertical() {
        if (vertical != null) {
            return String.format(Locale.US, "vertical: %b,", vertical);
        }
        return "";
    }

    private String generateJSvertical1() {
        if (vertical1 != null) {
            return String.format(Locale.US, "vertical: %s,", vertical1);
        }
        return "";
    }
