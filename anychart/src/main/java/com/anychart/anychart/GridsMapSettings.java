...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
    ...
    public GridsMapSettings setHorizontal(Boolean horizontal) {
        if (jsBase == null) {
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".horizontal(%b);", horizontal));
                js.setLength(0);
            }
        }
        return this;
    ...
    public GridsMapSettings setHorizontal(String horizontal1) {
        if (jsBase == null) {
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".horizontal(%s);", wrapQuotes(horizontal1)));
                js.setLength(0);
            }
        }
        return this;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    public GridsMapSettings setVertical(Boolean vertical) {
        if (jsBase == null) {
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".vertical(%b);", vertical));
                js.setLength(0);
            }
        }
        return this;
    ...
    public GridsMapSettings setVertical(String vertical1) {
        if (jsBase == null) {
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".vertical(%s);", wrapQuotes(vertical1)));
                js.setLength(0);
            }
        }
        return this;
     ...
     * Setter for the grid zIndex.
     */
    public GridsMapSettings setZIndex(String zIndex1) {
        if (jsBase == null) {
            this.zIndex = null;
            this.zIndex1 = null;
            ...
            js.append(String.format(Locale.US, ".zIndex(%s)", wrapQuotes(zIndex1)));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".zIndex(%s);", wrapQuotes(zIndex1)));
                js.setLength(0);
            }
        }
        return this;
