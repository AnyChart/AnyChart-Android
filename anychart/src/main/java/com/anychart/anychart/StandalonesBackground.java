...
public class StandalonesBackground extends UiBackground {
    ...
    public StandalonesBackground() {
        js.setLength(0);
        js.append("var standalonesBackground").append(++variableIndex).append(" = anychart.standalones.background();");
        jsBase = "standalonesBackground" + variableIndex;
    }

    protected StandalonesBackground(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected StandalonesBackground(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
     ...
     */
    public StandalonesBackground setContainer(String container) {
        if (jsBase == null) {
            this.container = null;
     ...
     * Setter for the background container.
     */
    public StandalonesBackground setContainer(Element container1) {
        if (jsBase == null) {
            this.container = null;
            this.container1 = null;
