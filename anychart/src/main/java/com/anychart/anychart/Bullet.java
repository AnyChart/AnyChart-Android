...
public class Bullet extends Chart {
    ...
    private Markers markerPalette1;
    ...
    public void setMarkerpalette(Markers markerPalette1) {
        this.markerPalette1 = markerPalette1;

        js.append(String.format(Locale.US, "chart.markerPalette(%s);", (markerPalette1 != null) ? markerPalette1.generateJs() : "null"));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.markerPalette(%s);", (markerPalette1 != null) ? markerPalette1.generateJs() : "null"));
            js.setLength(0);
        }
    }
    ...
    public void setRange(Double index5, Boolean range1) {
        this.index5 = index5;
        this.range1 = range1;

        js.append(String.format(Locale.US, "chart.range(%f, %b);", index5, range1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.range(%f, %b);", index5, range1));
            js.setLength(0);
        }
    }
    ...
    public void setRangepalette(String[] rangePalette1) {
        ...
        js.append(String.format(Locale.US, "chart.rangePalette(%s);", Arrays.toString(rangePalette1)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.rangePalette(%s);", Arrays.toString(rangePalette1)));
            js.setLength(0);
        }
    }
