...
public class Bullet extends Chart {
    ...
    public CoreAxesLinear getAxis() {
        if (getaxis == null)
            getaxis = new CoreAxesLinear("chart.axis()");
    ...
    public void setMarkerpalette(MarkerType[] markerPalette) {
        this.markerPalette = markerPalette;

        js.append(String.format(Locale.US, "chart.markerPalette(%s);", arrayToString(markerPalette)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.markerPalette(%s);", arrayToString(markerPalette)));
            js.setLength(0);
        }
    }
    ...
    public void setMarkerpalette(Markers markerPalette2) {
        this.markerPalette2 = markerPalette2;

        js.append(String.format(Locale.US, "chart.markerPalette(%s);", (markerPalette2 != null) ? markerPalette2.generateJs() : "null"));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.markerPalette(%s);", (markerPalette2 != null) ? markerPalette2.generateJs() : "null"));
            js.setLength(0);
        }
    }
    ...
    public void setRange(Double index4) {
        this.index4 = index4;

        js.append(String.format(Locale.US, "chart.range(%f);", index4));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.range(%f);", index4));
            js.setLength(0);
        }
    }
    ...
    public DistinctColors getRangepalette() {
        if (getrangePalette == null)
            getrangePalette = new DistinctColors("chart.rangePalette()");
    ...
    public void setRangepalette(DistinctColors rangePalette) {
        this.rangePalette = rangePalette;

        js.append(String.format(Locale.US, "chart.rangePalette(%s);", (rangePalette != null) ? rangePalette.generateJs() : "null"));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.rangePalette(%s);", (rangePalette != null) ? rangePalette.generateJs() : "null"));
            js.setLength(0);
        }
    }


    public void setRangepalette(String rangePalette1) {
        this.rangePalette1 = rangePalette1;

        js.append(String.format(Locale.US, "chart.rangePalette(%s);", rangePalette1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.rangePalette(%s);", rangePalette1));
            js.setLength(0);
        }
    }


    public void setRangepalette(String[] rangePalette2) {
        this.rangePalette2 = rangePalette2;

        js.append(String.format(Locale.US, "chart.rangePalette(%s);", Arrays.toString(rangePalette2)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.rangePalette(%s);", Arrays.toString(rangePalette2)));
            js.setLength(0);
        }
    }
    ...
    public void setScale(ScaleTypes scale1) {
        this.scale1 = scale1;
    ...
    public void setScale(String scale2) {
        ...
        js.append(String.format(Locale.US, "chart.scale(%s);", scale2));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.scale(%s);", scale2));
            js.setLength(0);
        }
    }
