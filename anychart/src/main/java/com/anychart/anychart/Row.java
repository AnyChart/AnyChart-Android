...
//            }
    ...
    public Cell setGetCell(Double col) {
        if (jsBase == null) {
            this.col = col;
        } else {
            this.col = col;
...
//            }
    ...
    public Row setMaxHeight(String maxHeight) {
        if (jsBase == null) {
            this.maxHeight = null;
...
//            }
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, ".maxHeight(%s)", maxHeight));
                js.setLength(0);
            }
        }
        return this;
    ...
    public Row setMaxHeight(Double maxHeight1) {
        if (jsBase == null) {
            this.maxHeight = null;
            this.maxHeight1 = null;
...
//            }
            ...
            js.append(String.format(Locale.US, ".maxHeight(%f)", maxHeight1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, ".maxHeight(%f)", maxHeight1));
                js.setLength(0);
            }
        }
        return this;
...
//            }
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, ".minHeight(%s)", minHeight));
                js.setLength(0);
            }
        }
        return this;
