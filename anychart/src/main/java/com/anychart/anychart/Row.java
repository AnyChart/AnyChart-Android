...
public class Row extends TableBase {
    ...
    public void setMaxheight(String maxHeight) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".maxHeight(%s);", maxHeight));
    ...
    public void setMaxheight(Double maxHeight1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".maxHeight(%f);", maxHeight1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".maxHeight(%f);", maxHeight1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setMinheight(String minHeight) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".minHeight(%s);", minHeight));
    ...
    public void setMinheight(Double minHeight1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".minHeight(%f);", minHeight1));
