...
// class
public class ScrollerseriesColumn extends ScrollerseriesDiscreteBase {

    private String jsBase;

    public ScrollerseriesColumn() {

    }

    protected ScrollerseriesColumn(String jsBase) {
        this.jsBase = jsBase;
    }
    ...
    private ColoredFill selectStroke1;
    private String selectStroke2;
    private Double thickness2;
    private String dashpattern;
    private StrokeLineJoin lineJoin;
    private StrokeLineCap lineCap;

    public void setSelectstroke(Stroke selectStroke, Double thickness2, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.selectStroke = null;
            this.selectStroke1 = null;
            this.selectStroke2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectStroke(%s, %f, %s, %s, %s);", (selectStroke != null) ? selectStroke.generateJs() : "null", thickness2, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectStroke(%s, %f, %s, %s, %s);", (selectStroke != null) ? selectStroke.generateJs() : "null", thickness2, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectstroke(ColoredFill selectStroke1, Double thickness2, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.selectStroke = null;
            this.selectStroke1 = null;
            this.selectStroke2 = null;
            
            this.selectStroke1 = selectStroke1;
            this.thickness = null;
            this.thickness1 = null;
            this.thickness2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectStroke(%s, %f, %s, %s, %s);", (selectStroke1 != null) ? selectStroke1.generateJs() : "null", thickness2, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectStroke(%s, %f, %s, %s, %s);", (selectStroke1 != null) ? selectStroke1.generateJs() : "null", thickness2, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectstroke(String selectStroke2, Double thickness2, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.selectStroke = null;
            this.selectStroke1 = null;
            this.selectStroke2 = null;
            
            this.selectStroke2 = selectStroke2;
            this.thickness = null;
            this.thickness1 = null;
            this.thickness2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectStroke(%s, %f, %s, %s, %s);", selectStroke2, thickness2, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectStroke(%s, %f, %s, %s, %s);", selectStroke2, thickness2, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    private String generateJSselectStroke() {
        if (selectStroke != null) {
            return String.format(Locale.US, "selectStroke: %s,", (selectStroke != null) ? selectStroke.generateJs() : "null");
        }
        return "";
    }

    private String generateJSselectStroke1() {
        if (selectStroke1 != null) {
            return String.format(Locale.US, "selectStroke: %s,", (selectStroke1 != null) ? selectStroke1.generateJs() : "null");
        }
        return "";
    }

    private String generateJSselectStroke2() {
        if (selectStroke2 != null) {
            return String.format(Locale.US, "selectStroke: %s,", selectStroke2);
        }
        return "";
    }
    ...
    protected String generateJs() {
        if (jsBase == null) {
            ...
            js.append(generateJSselectStroke());
            js.append(generateJSselectStroke1());
            js.append(generateJSselectStroke2());
