 ...
 */
public class CartesianSeriesStick extends WidthBased {

    public CartesianSeriesStick() {
        js.setLength(0);
        js.append("var cartesianSeriesStick").append(++variableIndex).append(" = anychart.core.cartesian.series.stick();");
        jsBase = "cartesianSeriesStick" + variableIndex;
    }

    protected CartesianSeriesStick(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected CartesianSeriesStick(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
    ...
    private List<CartesianSeriesStick> setStroke = new ArrayList<>();

    /**
     * Setter for stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public CartesianSeriesStick setStroke(Stroke color, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetStroke() {
        if (!setStroke.isEmpty()) {
            ...
            for (CartesianSeriesStick item : setStroke) {
    ...
    private List<CartesianSeriesStick> setStroke1 = new ArrayList<>();

    /**
     * Setter for stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public CartesianSeriesStick setStroke(ColoredFill color1, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetStroke1() {
        if (!setStroke1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesStick item : setStroke1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesStick> setStroke2 = new ArrayList<>();

    /**
     * Setter for stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public CartesianSeriesStick setStroke(String color2, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetStroke2() {
        if (!setStroke2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesStick item : setStroke2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
