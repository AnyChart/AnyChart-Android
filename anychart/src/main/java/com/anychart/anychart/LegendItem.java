...
public class LegendItem extends CoreText {
    ...
    public void setIconhatchfill(PatternFill patternFillOrType, String color, Double thickness, Double size) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %f, %f);", (patternFillOrType != null) ? patternFillOrType.generateJs() : "null", color, thickness, size));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %f, %f);", (patternFillOrType != null) ? patternFillOrType.generateJs() : "null", color, thickness, size));
                js.setLength(0);
            }
        }
    }
    ...
    public void setIconhatchfill(HatchFill patternFillOrType1, String color, Double thickness, Double size) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %f, %f);", (patternFillOrType1 != null) ? patternFillOrType1.generateJs() : "null", color, thickness, size));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %f, %f);", (patternFillOrType1 != null) ? patternFillOrType1.generateJs() : "null", color, thickness, size));
                js.setLength(0);
            }
        }
    }
    ...
    public void setIconhatchfill(HatchFillType patternFillOrType2, String color, Double thickness, Double size) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %f, %f);", (patternFillOrType2 != null) ? patternFillOrType2.generateJs() : "null", color, thickness, size));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %f, %f);", (patternFillOrType2 != null) ? patternFillOrType2.generateJs() : "null", color, thickness, size));
                js.setLength(0);
            }
        }
    }
    ...
    public void setIconhatchfill(String patternFillOrType3, String color, Double thickness, Double size) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %f, %f);", patternFillOrType3, color, thickness, size));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".iconHatchFill(%s, %s, %f, %f);", patternFillOrType3, color, thickness, size));
                js.setLength(0);
            }
        }
    }
    ...
    public void setIconstroke(Stroke iconStroke) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".iconStroke(%s);", (iconStroke != null) ? iconStroke.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".iconStroke(%s);", (iconStroke != null) ? iconStroke.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setIcontype(String iconType) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".iconType(%s);", iconType));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".iconType(%s);", iconType));
                js.setLength(0);
            }
        }
    }
    ...
    public void setX(Double x) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".x(%f);", x));
    ...
    public void setX(String x1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".x(%s);", x1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".x(%s);", x1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setY(Double y) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".y(%f);", y));
    ...
    public void setY(String y1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".y(%s);", y1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".y(%s);", y1));
                js.setLength(0);
            }
        }
    }
