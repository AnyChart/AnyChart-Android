 ...
 */
public class Polyline extends PolarSeriesContinuousBase {

    public Polyline() {
        js.setLength(0);
        js.append("var polyline").append(++variableIndex).append(" = anychart.core.polar.series.polyline();");
        jsBase = "polyline" + variableIndex;
    }

    protected Polyline(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected Polyline(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
    ...
    private List<Polyline> setStroke = new ArrayList<>();
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    private List<Polyline> setStroke1 = new ArrayList<>();
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    private List<Polyline> setStroke2 = new ArrayList<>();
