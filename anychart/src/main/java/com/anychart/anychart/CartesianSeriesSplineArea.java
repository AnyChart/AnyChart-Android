 ...
 */
public class CartesianSeriesSplineArea extends CartesianSeriesContinuousBase {

    public CartesianSeriesSplineArea() {
        js.setLength(0);
        js.append("var cartesianSeriesSplineArea").append(++variableIndex).append(" = anychart.core.cartesian.series.splineArea();");
        jsBase = "cartesianSeriesSplineArea" + variableIndex;
    }

    protected CartesianSeriesSplineArea(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected CartesianSeriesSplineArea(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
    ...
    private Fill fill;
    private List<CartesianSeriesSplineArea> setFill = new ArrayList<>();

    /**
     * Setter for fill settings using an array or a string.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public CartesianSeriesSplineArea setFill(Fill fill) {
        if (jsBase == null) {
            this.fill = fill;
        } else {
            this.fill = fill;
    ...
    private String generateJSsetFill() {
        if (!setFill.isEmpty()) {
            ...
            for (CartesianSeriesSplineArea item : setFill) {
    ...
    private List<CartesianSeriesSplineArea> setFill1 = new ArrayList<>();
    ...
    private String generateJSsetFill1() {
        if (!setFill1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setFill2 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public CartesianSeriesSplineArea fill(GradientKey[] keys, Boolean mode, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill2() {
        if (!setFill2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setFill3 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public CartesianSeriesSplineArea fill(GradientKey[] keys, VectorRect mode1, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill3() {
        if (!setFill3.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill3) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setFill4 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public CartesianSeriesSplineArea fill(GradientKey[] keys, String mode2, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill4() {
        if (!setFill4.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill4) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setFill5 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public CartesianSeriesSplineArea fill(String[] keys1, Boolean mode, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill5() {
        if (!setFill5.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill5) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setFill6 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public CartesianSeriesSplineArea fill(String[] keys1, VectorRect mode1, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill6() {
        if (!setFill6.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill6) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setFill7 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public CartesianSeriesSplineArea fill(String[] keys1, String mode2, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill7() {
        if (!setFill7.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill7) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private Double fx;
    private Double fy;
    private List<CartesianSeriesSplineArea> setFill8 = new ArrayList<>();
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
    ...
    private String generateJSsetFill8() {
        if (!setFill8.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill8) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setFill9 = new ArrayList<>();
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
    ...
    private String generateJSsetFill9() {
        if (!setFill9.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setFill9) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private Double size;
    private List<CartesianSeriesSplineArea> setHatchFill = new ArrayList<>();
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
    ...
    private String generateJSsetHatchFill() {
        if (!setHatchFill.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setHatchFill) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setHatchFill1 = new ArrayList<>();
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
    ...
    private String generateJSsetHatchFill1() {
        if (!setHatchFill1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setHatchFill1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setHatchFill2 = new ArrayList<>();
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
    ...
    private String generateJSsetHatchFill2() {
        if (!setHatchFill2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setHatchFill2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setHatchFill3 = new ArrayList<>();
...
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
    ...
    private String generateJSsetHatchFill3() {
        if (!setHatchFill3.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setHatchFill3) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setStroke = new ArrayList<>();
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    private String generateJSsetStroke() {
        if (!setStroke.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setStroke) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setStroke1 = new ArrayList<>();
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    private String generateJSsetStroke1() {
        if (!setStroke1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setStroke1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<CartesianSeriesSplineArea> setStroke2 = new ArrayList<>();
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    private String generateJSsetStroke2() {
        if (!setStroke2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (CartesianSeriesSplineArea item : setStroke2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
