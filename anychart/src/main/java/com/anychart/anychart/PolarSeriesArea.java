...
// class
public class PolarSeriesArea extends PolarSeriesContinuousBase {

    private String jsBase;

    public PolarSeriesArea() {

    }

    protected PolarSeriesArea(String jsBase) {
        this.jsBase = jsBase;
    }
    ...
    public void setSelecthatchfill(Boolean patternFillOrType12, String color6, Double thickness3, Double size2) {
        if (jsBase == null) {
            this.patternFillOrType = null;
            this.patternFillOrType1 = null;
            this.patternFillOrType2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectHatchFill(%b, %s, %f, %f);", patternFillOrType12, color6, thickness3, size2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectHatchFill(%b, %s, %f, %f);", patternFillOrType12, color6, thickness3, size2));
                js.setLength(0);
            }
        }
    }
