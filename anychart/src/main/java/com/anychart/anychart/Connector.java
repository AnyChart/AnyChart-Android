...
public class Connector extends JsObject {
    ...
    public void setCurvature(Double curvature) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".curvature(%f);", curvature));
    ...
    public void setCurvature(String curvature1) {
        if (jsBase == null) {
            this.curvature = null;
            this.curvature1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".curvature(%s);", curvature1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".curvature(%s);", curvature1));
                js.setLength(0);
            }
        }
    }
