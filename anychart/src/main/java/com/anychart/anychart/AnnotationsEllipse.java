...
public class AnnotationsEllipse extends AnnotationsBase {
    ...
    public AnnotationsEllipse() {
        js.setLength(0);
        js.append("var annotationsEllipse").append(++variableIndex).append(" = anychart.core.annotations.ellipse();");
        jsBase = "annotationsEllipse" + variableIndex;
    }
    ...
    protected AnnotationsEllipse(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse setFill(Fill fill) {
        if (jsBase == null) {
            this.fill = fill;
        } else {
            this.fill = fill;
     ...
     * 
     */
    public AnnotationsEllipse setFill(String json) {
        if (jsBase == null) {
        } else {
            if (!isChain) {
                js.append(jsBase);
     ...
     */
    public AnnotationsEllipse fill(String color, Number opacity) {
        if (jsBase == null) {
            this.color = color;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse fill(GradientKey[] keys, Number angle, Number opacity1, Boolean mode) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse fill(GradientKey[] keys, Number angle, Number opacity1, VectorRect mode1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse fill(GradientKey[] keys, Number angle, Number opacity1, String mode2) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse fill(String[] keys1, Number angle, Number opacity1, Boolean mode) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse fill(String[] keys1, Number angle, Number opacity1, VectorRect mode1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse fill(String[] keys1, Number angle, Number opacity1, String mode2) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse fill(GradientKey[] keys2, Number cx, Number cy, GraphicsMathRect mode3, Number opacity2, Number fx, Number fy) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            this.keys2 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public AnnotationsEllipse fill(String[] keys3, Number cx, Number cy, GraphicsMathRect mode3, Number opacity2, Number fx, Number fy) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            this.keys2 = null;
     ...
     */
    public AnnotationsEllipse setHatchFill(PatternFill patternFillOrType, String color1, Number thickness, Number size) {
        if (jsBase == null) {
     ...
     * Setter for hatch fill settings.
     */
    public AnnotationsEllipse setHatchFill(HatchFill patternFillOrType1, String color1, Number thickness, Number size) {
        if (jsBase == null) {
            this.patternFillOrType = null;
            this.patternFillOrType1 = null;
            this.patternFillOrType2 = null;
     ...
     * Setter for hatch fill settings.
     */
    public AnnotationsEllipse setHatchFill(HatchFillType patternFillOrType2, String color1, Number thickness, Number size) {
        if (jsBase == null) {
            this.patternFillOrType = null;
            this.patternFillOrType1 = null;
            this.patternFillOrType2 = null;
     ...
     * Setter for hatch fill settings.
     */
    public AnnotationsEllipse setHatchFill(String patternFillOrType3, String color1, Number thickness, Number size) {
        if (jsBase == null) {
            this.patternFillOrType = null;
            this.patternFillOrType1 = null;
            this.patternFillOrType2 = null;
     ...
     * Setter for hatch fill settings.
     */
    public AnnotationsEllipse setHatchFill(Boolean patternFillOrType4, String color1, Number thickness, Number size) {
        if (jsBase == null) {
            this.patternFillOrType = null;
            this.patternFillOrType1 = null;
            this.patternFillOrType2 = null;
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".hatchFill(%b, %s, %s, %s);", patternFillOrType4, wrapQuotes(color1), thickness, size));
                js.setLength(0);
            }
        }
        return this;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public AnnotationsEllipse setStroke(Stroke color2, Number thickness1, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
     ...
     * 
     */
    public AnnotationsEllipse setStroke(String json) {
        if (jsBase == null) {
        } else {
            if (!isChain) {
                js.append(jsBase);
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public AnnotationsEllipse setStroke(ColoredFill color3, Number thickness1, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public AnnotationsEllipse setStroke(String color4, Number thickness1, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
