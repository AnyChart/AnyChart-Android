...
public class Thermometer extends LineargaugePointersBase {
    ...
    public void setBulbpadding(String bulbPadding) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".bulbPadding(%s);", bulbPadding));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".bulbPadding(%s);", bulbPadding));
                js.setLength(0);
            }
        }
    }
    ...
    public void setBulbpadding(Double bulbPadding1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".bulbPadding(%f);", bulbPadding1));
    ...
    public void setBulbradius(String bulbRadius) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".bulbRadius(%s);", bulbRadius));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".bulbRadius(%s);", bulbRadius));
                js.setLength(0);
            }
        }
    }
