...
public class GaugePointersMarker extends JsObject {
    ...
    public void setSize(String size2) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".size(%s);", size2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".size(%s);", size2));
                js.setLength(0);
            }
        }
    }
    ...
    private MarkerType type3;
    private String type4;

    public void setType(MarkerType type3) {
        if (jsBase == null) {
            this.type = null;
            this.type1 = null;
            this.type2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".type(%s);", (type3 != null) ? type3.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".type(%s);", (type3 != null) ? type3.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setType(String type4) {
        if (jsBase == null) {
            this.type = null;
            this.type1 = null;
            this.type2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".type(%s);", type4));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".type(%s);", type4));
                js.setLength(0);
            }
        }
    }
    ...
    private String generateJSsize2() {
        if (size2 != null) {
            return String.format(Locale.US, "size: %s,", size2);
        }
        return "";
    }
