...
// class
public class Intersections extends JsObject {
    ...
    protected Intersections(String jsBase) {
        this.jsBase = jsBase;
    }
    ...
    public void setHoverhatchfill(HatchFillType patternFillOrType7, String color3, Double thickness1, Double size1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".hoverHatchFill(%s, %s, %f, %f);", (patternFillOrType7 != null) ? patternFillOrType7.generateJs() : "null", color3, thickness1, size1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".hoverHatchFill(%s, %s, %f, %f);", (patternFillOrType7 != null) ? patternFillOrType7.generateJs() : "null", color3, thickness1, size1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setHoverhatchfill(String patternFillOrType8, String color3, Double thickness1, Double size1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".hoverHatchFill(%s, %s, %f, %f);", patternFillOrType8, color3, thickness1, size1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".hoverHatchFill(%s, %s, %f, %f);", patternFillOrType8, color3, thickness1, size1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setHoverhatchfill(Boolean patternFillOrType9, String color3, Double thickness1, Double size1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".hoverHatchFill(%b, %s, %f, %f);", patternFillOrType9, color3, thickness1, size1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".hoverHatchFill(%b, %s, %f, %f);", patternFillOrType9, color3, thickness1, size1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelecthatchfill(PatternFill patternFillOrTypeOrState, String color8, Double thickness3, Double size2) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".selectHatchFill(%s, %s, %f, %f);", (patternFillOrTypeOrState != null) ? patternFillOrTypeOrState.generateJs() : "null", color8, thickness3, size2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectHatchFill(%s, %s, %f, %f);", (patternFillOrTypeOrState != null) ? patternFillOrTypeOrState.generateJs() : "null", color8, thickness3, size2));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelecthatchfill(HatchFill patternFillOrTypeOrState1, String color8, Double thickness3, Double size2) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".selectHatchFill(%s, %s, %f, %f);", (patternFillOrTypeOrState1 != null) ? patternFillOrTypeOrState1.generateJs() : "null", color8, thickness3, size2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectHatchFill(%s, %s, %f, %f);", (patternFillOrTypeOrState1 != null) ? patternFillOrTypeOrState1.generateJs() : "null", color8, thickness3, size2));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelecthatchfill(HatchFillType patternFillOrTypeOrState2, String color8, Double thickness3, Double size2) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".selectHatchFill(%s, %s, %f, %f);", (patternFillOrTypeOrState2 != null) ? patternFillOrTypeOrState2.generateJs() : "null", color8, thickness3, size2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectHatchFill(%s, %s, %f, %f);", (patternFillOrTypeOrState2 != null) ? patternFillOrTypeOrState2.generateJs() : "null", color8, thickness3, size2));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelecthatchfill(String patternFillOrTypeOrState3, String color8, Double thickness3, Double size2) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".selectHatchFill(%s, %s, %f, %f);", patternFillOrTypeOrState3, color8, thickness3, size2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectHatchFill(%s, %s, %f, %f);", patternFillOrTypeOrState3, color8, thickness3, size2));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelecthatchfill(Boolean patternFillOrTypeOrState4, String color8, Double thickness3, Double size2) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".selectHatchFill(%b, %s, %f, %f);", patternFillOrTypeOrState4, color8, thickness3, size2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectHatchFill(%b, %s, %f, %f);", patternFillOrTypeOrState4, color8, thickness3, size2));
                js.setLength(0);
            }
        }
    }
