...
// class
public class AnnotationsMarker extends JsObject {
    ...
    public void setMarkertype(MarkerType markerType) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".markerType(%s);", (markerType != null) ? markerType.generateJs() : "null"));
    ...
    public void setMarkertype(String markerType1) {
        if (jsBase == null) {
            this.markerType = null;
            this.markerType1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".markerType(%s);", markerType1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".markerType(%s);", markerType1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectsize(Double selectSize) {
        if (jsBase == null) {
            this.selectSize = selectSize;
        } else {
            this.selectSize = selectSize;

            js.append(String.format(Locale.US, jsBase + ".selectSize(%f);", selectSize));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectSize(%f);", selectSize));
                js.setLength(0);
            }
        }
    }
    ...
    private String generateJSmarkerType() {
        if (markerType != null) {
            return String.format(Locale.US, "markerType: %s,", (markerType != null) ? markerType.generateJs() : "null");
        }
        return "";
    }

    private String generateJSmarkerType1() {
        if (markerType1 != null) {
            return String.format(Locale.US, "markerType: %s,", markerType1);
        }
        return "";
    }
    ...
    private String generateJSselectSize() {
        if (selectSize != null) {
            return String.format(Locale.US, "selectSize: %f,", selectSize);
        }
        return "";
    }
    ...
    protected String generateJs() {
        if (jsBase == null) {
            ...
            js.append(generateJSselectSize());
