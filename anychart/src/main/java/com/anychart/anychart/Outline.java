 ...
 * Outline class.
 */
public class Outline extends CoreBase {

    public Outline() {
        js.setLength(0);
        js.append("var outline").append(++variableIndex).append(" = anychart.core.ui.outline();");
        jsBase = "outline" + variableIndex;
    }

    protected Outline(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected Outline(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
     ...
     */
    public Outline setEnabled(Boolean enabled) {
        if (jsBase == null) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline setFill(Fill function) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, ".fill(%s)", ((function != null) ? function.generateJs() : "null")));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".fill(%s);", ((function != null) ? function.generateJs() : "null")));
                js.setLength(0);
            }
        }
        return this;
     ...
     */
    public Outline fill(String color, Number opacity) {
        if (jsBase == null) {
            this.color = color;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline fill(GradientKey[] keys, Number angle, Number opacity1, Boolean mode) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline fill(GradientKey[] keys, Number angle, Number opacity1, VectorRect mode1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline fill(GradientKey[] keys, Number angle, Number opacity1, String mode2) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline fill(String[] keys1, Number angle, Number opacity1, Boolean mode) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline fill(String[] keys1, Number angle, Number opacity1, VectorRect mode1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline fill(String[] keys1, Number angle, Number opacity1, String mode2) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline fill(GradientKey[] keys2, Number cx, Number cy, GraphicsMathRect mode3, Number opacity2, Number fx, Number fy) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            this.keys2 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Outline fill(String[] keys3, Number cx, Number cy, GraphicsMathRect mode3, Number opacity2, Number fx, Number fy) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            this.keys2 = null;
     ...
     */
    public Outline setOffset(String offset) {
        if (jsBase == null) {
            this.offset = null;
            this.offset1 = null;
     ...
     * Setter for the outline offset.
     */
    public Outline setOffset(Number offset1) {
        if (jsBase == null) {
            this.offset = null;
            this.offset1 = null;
            ...
            js.append(String.format(Locale.US, ".offset(%f)", offset1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".offset(%f);", offset1));
                js.setLength(0);
            }
        }
        return this;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    public MapSeriesBase setStroke(ColoredFill color2, Number thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, "var setStroke1" + ++variableIndex + " = " + jsBase + ".stroke(%s, %f, %s, %s, %s);", ((color2 != null) ? color2.generateJs() : "null"), thickness, wrapQuotes(dashpattern), ((lineJoin != null) ? lineJoin.generateJs() : "null"), ((lineCap != null) ? lineCap.generateJs() : "null")));
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    public MapSeriesBase setStroke(String color3, Number thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, "var setStroke2" + ++variableIndex + " = " + jsBase + ".stroke(%s, %f, %s, %s, %s);", wrapQuotes(color3), thickness, wrapQuotes(dashpattern), ((lineJoin != null) ? lineJoin.generateJs() : "null"), ((lineCap != null) ? lineCap.generateJs() : "null")));
     ...
     */
    public Outline setWidth(String width) {
        if (jsBase == null) {
            this.width = null;
            this.width1 = null;
     ...
     * Setter for the outline width.
     */
    public Outline setWidth(Number width1) {
        if (jsBase == null) {
            this.width = null;
            this.width1 = null;
