...
public class TrendChannel extends AnnotationsBase {
    ...
    public TrendChannel() {
        js.setLength(0);
        js.append("var trendChannel").append(++variableIndex).append(" = anychart.core.annotations.trendChannel();");
        jsBase = "trendChannel" + variableIndex;
    }

    protected TrendChannel(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected TrendChannel(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
    ...
    private Fill fill;
    private List<TrendChannel> setFill = new ArrayList<>();

    /**
     * Setter for fill settings using an array or a string.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public TrendChannel setFill(Fill fill) {
        if (jsBase == null) {
            this.fill = fill;
        } else {
            this.fill = fill;
    ...
    private List<TrendChannel> setFill1 = new ArrayList<>();
    ...
    private String generateJSsetFill1() {
        if (!setFill1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setFill2 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public TrendChannel fill(GradientKey[] keys, Boolean mode, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill2() {
        if (!setFill2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setFill3 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public TrendChannel fill(GradientKey[] keys, VectorRect mode1, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill3() {
        if (!setFill3.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill3) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setFill4 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public TrendChannel fill(GradientKey[] keys, String mode2, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill4() {
        if (!setFill4.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill4) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setFill5 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public TrendChannel fill(String[] keys1, Boolean mode, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill5() {
        if (!setFill5.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill5) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setFill6 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public TrendChannel fill(String[] keys1, VectorRect mode1, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill6() {
        if (!setFill6.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill6) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setFill7 = new ArrayList<>();

    /**
     * Linear gradient fill.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public TrendChannel fill(String[] keys1, String mode2, Double angle, Double opacity1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
    ...
    private String generateJSsetFill7() {
        if (!setFill7.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill7) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private Double fx;
    private Double fy;
    private List<TrendChannel> setFill8 = new ArrayList<>();
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
    ...
    private String generateJSsetFill8() {
        if (!setFill8.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill8) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setFill9 = new ArrayList<>();
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
    ...
    private String generateJSsetFill9() {
        if (!setFill9.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setFill9) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private Double size;
    private List<TrendChannel> setHatchFill = new ArrayList<>();
    ...
    private String generateJSsetHatchFill() {
        if (!setHatchFill.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setHatchFill) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setHatchFill1 = new ArrayList<>();
    ...
    private String generateJSsetHatchFill1() {
        if (!setHatchFill1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setHatchFill1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setHatchFill2 = new ArrayList<>();
    ...
    private String generateJSsetHatchFill2() {
        if (!setHatchFill2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setHatchFill2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setHatchFill3 = new ArrayList<>();
    ...
    private String generateJSsetHatchFill3() {
        if (!setHatchFill3.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setHatchFill3) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setHatchFill4 = new ArrayList<>();
    ...
    private String generateJSsetHatchFill4() {
        if (!setHatchFill4.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setHatchFill4) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setStroke = new ArrayList<>();
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    private String generateJSsetStroke() {
        if (!setStroke.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setStroke) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setStroke1 = new ArrayList<>();
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    private String generateJSsetStroke1() {
        if (!setStroke1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setStroke1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<TrendChannel> setStroke2 = new ArrayList<>();
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    private String generateJSsetStroke2() {
        if (!setStroke2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (TrendChannel item : setStroke2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
