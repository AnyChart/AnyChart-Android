 ...
 */
public class StockSeriesRangeStepArea extends StockSeriesBase {

    public StockSeriesRangeStepArea() {
        js.setLength(0);
        js.append("var stockSeriesRangeStepArea").append(++variableIndex).append(" = anychart.core.stock.series.rangeStepArea();");
        jsBase = "stockSeriesRangeStepArea" + variableIndex;
    }

    protected StockSeriesRangeStepArea(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected StockSeriesRangeStepArea(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
    ...
    private Fill fill;
    private List<StockSeriesRangeStepArea> setFill = new ArrayList<>();

    /**
     * Setter for fill settings using an object or a string.
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public StockSeriesRangeStepArea setFill(Fill fill) {
        if (jsBase == null) {
            this.fill = fill;
        } else {
            this.fill = fill;
    ...
    private String generateJSsetFill() {
        if (!setFill.isEmpty()) {
            ...
            for (StockSeriesRangeStepArea item : setFill) {
    ...
    private List<StockSeriesRangeStepArea> setFill1 = new ArrayList<>();

    /**
     * Fill color with opacity.
     */
    public StockSeriesRangeStepArea fill(String color, Double opacity) {
        if (jsBase == null) {
            this.color = color;
    ...
    private String generateJSsetFill1() {
        if (!setFill1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setFill1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private Double size;
    private List<StockSeriesRangeStepArea> setHatchFill = new ArrayList<>();

    /**
     * Setter for hatch fill settings.
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
     */
    public StockSeriesRangeStepArea setHatchFill(PatternFill patternFillOrType, String color1, Double thickness, Double size) {
        if (jsBase == null) {
    ...
    private String generateJSsetHatchFill() {
        if (!setHatchFill.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setHatchFill) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setHatchFill1 = new ArrayList<>();

    /**
     * Setter for hatch fill settings.
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
     */
    public StockSeriesRangeStepArea setHatchFill(HatchFill patternFillOrType1, String color1, Double thickness, Double size) {
        if (jsBase == null) {
            this.patternFillOrType = null;
            this.patternFillOrType1 = null;
            this.patternFillOrType2 = null;
    ...
    private String generateJSsetHatchFill1() {
        if (!setHatchFill1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setHatchFill1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setHatchFill2 = new ArrayList<>();

    /**
     * Setter for hatch fill settings.
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
     */
    public StockSeriesRangeStepArea setHatchFill(HatchFillType patternFillOrType2, String color1, Double thickness, Double size) {
        if (jsBase == null) {
            this.patternFillOrType = null;
            this.patternFillOrType1 = null;
            this.patternFillOrType2 = null;
    ...
    private String generateJSsetHatchFill2() {
        if (!setHatchFill2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setHatchFill2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setHatchFill3 = new ArrayList<>();

    /**
     * Setter for hatch fill settings.
{docs:Graphics/Hatch_Fill_Settings}Learn more about hatch fill settings.{docs}
     */
    public StockSeriesRangeStepArea setHatchFill(String patternFillOrType3, String color1, Double thickness, Double size) {
        if (jsBase == null) {
            this.patternFillOrType = null;
            this.patternFillOrType1 = null;
            this.patternFillOrType2 = null;
    ...
    private String generateJSsetHatchFill3() {
        if (!setHatchFill3.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setHatchFill3) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setHighStroke = new ArrayList<>();

    /**
     * Setter for high stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public StockSeriesRangeStepArea setHighStroke(Stroke color2, Double thickness1, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetHighStroke() {
        if (!setHighStroke.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setHighStroke) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setHighStroke1 = new ArrayList<>();

    /**
     * Setter for high stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public StockSeriesRangeStepArea setHighStroke(ColoredFill color3, Double thickness1, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetHighStroke1() {
        if (!setHighStroke1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setHighStroke1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setHighStroke2 = new ArrayList<>();

    /**
     * Setter for high stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public StockSeriesRangeStepArea setHighStroke(String color4, Double thickness1, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetHighStroke2() {
        if (!setHighStroke2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setHighStroke2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setLowStroke = new ArrayList<>();

    /**
     * Setter for low stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public StockSeriesRangeStepArea setLowStroke(Stroke color5, Double thickness2, String dashpattern1, StrokeLineJoin lineJoin1, StrokeLineCap lineCap1) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetLowStroke() {
        if (!setLowStroke.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setLowStroke) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setLowStroke1 = new ArrayList<>();

    /**
     * Setter for low stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public StockSeriesRangeStepArea setLowStroke(ColoredFill color6, Double thickness2, String dashpattern1, StrokeLineJoin lineJoin1, StrokeLineCap lineCap1) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetLowStroke1() {
        if (!setLowStroke1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setLowStroke1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setLowStroke2 = new ArrayList<>();

    /**
     * Setter for low stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public StockSeriesRangeStepArea setLowStroke(String color7, Double thickness2, String dashpattern1, StrokeLineJoin lineJoin1, StrokeLineCap lineCap1) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetLowStroke2() {
        if (!setLowStroke2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setLowStroke2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setStepDirection = new ArrayList<>();

    /**
     * Setter for the step direction.
     */
    public StockSeriesRangeStepArea setStepDirection(StepDirection stepDirection) {
        if (jsBase == null) {
    ...
    private String generateJSsetStepDirection() {
        if (!setStepDirection.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setStepDirection) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StockSeriesRangeStepArea> setStepDirection1 = new ArrayList<>();

    /**
     * Setter for the step direction.
     */
    public StockSeriesRangeStepArea setStepDirection(String stepDirection1) {
        if (jsBase == null) {
            this.stepDirection = null;
            this.stepDirection1 = null;
    ...
    private String generateJSsetStepDirection1() {
        if (!setStepDirection1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StockSeriesRangeStepArea item : setStepDirection1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
