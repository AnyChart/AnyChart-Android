...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     ...
     * 
     */
    public ScaleBar setFill(String json) {
        if (jsBase == null) {
        } else {
            if (!isChain) {
                js.append(jsBase);
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
    ...
    public ScaleBar setFrom(Number from1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, ".from(%s)", from1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".from(%s);", from1));
                js.setLength(0);
            }
        }
        return this;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     * 
     */
    public ScaleBar setStroke(String json) {
        if (jsBase == null) {
        } else {
            if (!isChain) {
                js.append(jsBase);
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    public ScaleBar setTo(Number to1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, ".to(%s)", to1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".to(%s);", to1));
                js.setLength(0);
            }
        }
        return this;
