...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
    ...
    public ScaleBar setFrom(String from) {
        if (jsBase == null) {
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".from(%s);", wrapQuotes(from)));
                js.setLength(0);
            }
        }
        return this;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
    ...
    public ScaleBar setTo(String to) {
        if (jsBase == null) {
            ...
            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".to(%s);", wrapQuotes(to)));
                js.setLength(0);
            }
        }
        return this;
