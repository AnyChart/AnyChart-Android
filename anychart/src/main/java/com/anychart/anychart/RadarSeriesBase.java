...
public class RadarSeriesBase extends AnychartSeriesBase {
     ...
     */
    public RadarSeriesBase setMaxLabels(String settings) {
        if (jsBase == null) {
            this.settings = null;
            this.settings1 = null;
     ...
     * Setter for maximum labels.
     */
    public RadarSeriesBase setMaxLabels(Boolean settings1) {
        if (jsBase == null) {
            this.settings = null;
            this.settings1 = null;
     ...
     */
    public RadarSeriesBase setMinLabels(String settings2) {
        if (jsBase == null) {
            this.settings = null;
            this.settings1 = null;
            this.settings2 = null;
     ...
     * Setter for minimum labels.
     */
    public RadarSeriesBase setMinLabels(Boolean settings3) {
        if (jsBase == null) {
            this.settings = null;
            this.settings1 = null;
            this.settings2 = null;
    ...
    public void transformXY(Number xSubRangeRatio) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, "var " + ++variableIndex + " = " + jsBase + ".transformXY(%s);", xSubRangeRatio));
            

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".transformXY(%s);", xSubRangeRatio));
                js.setLength(0);
            }
        }
    }
