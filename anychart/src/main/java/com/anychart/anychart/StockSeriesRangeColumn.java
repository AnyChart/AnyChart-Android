...
// class
public class StockSeriesRangeColumn extends JsObject {
    ...
    public void setHoverfill(String color2, Double opacity1) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".hoverFill(%s, %f);", color2, opacity1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".hoverFill(%s, %f);", color2, opacity1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectfill(String color7, Double opacity2) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %f);", color7, opacity2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %f);", color7, opacity2));
                js.setLength(0);
            }
        }
    }
