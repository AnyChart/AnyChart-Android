...
public class HorizontalLine extends AnnotationsBase {
    ...
    public HorizontalLine() {
        js.setLength(0);
        js.append("var horizontalLine").append(++variableIndex).append(" = anychart.core.annotations.horizontalLine();");
        jsBase = "horizontalLine" + variableIndex;
    }

    protected HorizontalLine(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected HorizontalLine(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
    ...
    private List<HorizontalLine> setStroke = new ArrayList<>();

    /**
     * Setter for annotations stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public HorizontalLine setStroke(Stroke color, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetStroke() {
        if (!setStroke.isEmpty()) {
            ...
            for (HorizontalLine item : setStroke) {
    ...
    private List<HorizontalLine> setStroke1 = new ArrayList<>();

    /**
     * Setter for annotations stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public HorizontalLine setStroke(ColoredFill color1, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetStroke1() {
        if (!setStroke1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (HorizontalLine item : setStroke1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<HorizontalLine> setStroke2 = new ArrayList<>();

    /**
     * Setter for annotations stroke settings.
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public HorizontalLine setStroke(String color2, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
    ...
    private String generateJSsetStroke2() {
        if (!setStroke2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (HorizontalLine item : setStroke2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
