...
public class MFI extends JsObject {
    ...
    public MFI() {
        js.setLength(0);
        js.append("var mFI").append(++variableIndex).append(" = anychart.core.stock.indicators.mFI();");
        jsBase = "mFI" + variableIndex;
    }

    protected MFI(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected MFI(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
