...
public class Pert extends Chart {
    ...
    public CriticalPath getCriticalpath() {
        if (getcriticalPath == null)
            getcriticalPath = new CriticalPath("chart.criticalPath()");
    ...
    public void setCriticalpath(String criticalPath) {
        ...
        js.append(String.format(Locale.US, "chart.criticalPath(%s);", criticalPath));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.criticalPath(%s);", criticalPath));
            js.setLength(0);
        }
    }
    ...
    public void setData(Tree data, TreeFillingMethod fillMethod, Dependency[] deps) {
        this.data = data;
        this.fillMethod = fillMethod;
        this.deps = deps;

        js.append(String.format(Locale.US, "chart.data(%s, %s, %s);", (data != null) ? data.generateJs() : "null", (fillMethod != null) ? fillMethod.generateJs() : "null", arrayToString(deps)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.data(%s, %s, %s);", (data != null) ? data.generateJs() : "null", (fillMethod != null) ? fillMethod.generateJs() : "null", arrayToString(deps)));
            js.setLength(0);
        }
    }


    public void setData(Tree data, String fillMethod1, Dependency[] deps) {
        this.data = data;
        this.fillMethod1 = fillMethod1;
        this.deps = deps;

        js.append(String.format(Locale.US, "chart.data(%s, %s, %s);", (data != null) ? data.generateJs() : "null", fillMethod1, arrayToString(deps)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.data(%s, %s, %s);", (data != null) ? data.generateJs() : "null", fillMethod1, arrayToString(deps)));
            js.setLength(0);
        }
    }


    public void setData(TreeView data1, TreeFillingMethod fillMethod, Dependency[] deps) {
        this.data1 = data1;
        this.fillMethod = fillMethod;
        this.deps = deps;

        js.append(String.format(Locale.US, "chart.data(%s, %s, %s);", (data1 != null) ? data1.generateJs() : "null", (fillMethod != null) ? fillMethod.generateJs() : "null", arrayToString(deps)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.data(%s, %s, %s);", (data1 != null) ? data1.generateJs() : "null", (fillMethod != null) ? fillMethod.generateJs() : "null", arrayToString(deps)));
            js.setLength(0);
        }
    }


    public void setData(TreeView data1, String fillMethod1, Dependency[] deps) {
        this.data1 = data1;
        this.fillMethod1 = fillMethod1;
        this.deps = deps;

        js.append(String.format(Locale.US, "chart.data(%s, %s, %s);", (data1 != null) ? data1.generateJs() : "null", fillMethod1, arrayToString(deps)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.data(%s, %s, %s);", (data1 != null) ? data1.generateJs() : "null", fillMethod1, arrayToString(deps)));
            js.setLength(0);
        }
    }


    public void setData(String data2, TreeFillingMethod fillMethod, Dependency[] deps) {
        this.data2 = data2;
        this.fillMethod = fillMethod;
        this.deps = deps;
    ...
    public void setData(String data2, String fillMethod1, Dependency[] deps) {
        this.data2 = data2;
        this.fillMethod1 = fillMethod1;
        this.deps = deps;

        js.append(String.format(Locale.US, "chart.data(%s, %s, %s);", data2, fillMethod1, arrayToString(deps)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.data(%s, %s, %s);", data2, fillMethod1, arrayToString(deps)));
            js.setLength(0);
        }
    }
    ...
    public void setHorizontalspacing(Double horizontalSpacing) {
        ...
        js.append(String.format(Locale.US, "chart.horizontalSpacing(%f);", horizontalSpacing));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.horizontalSpacing(%f);", horizontalSpacing));
            js.setLength(0);
        }
    }


    public void setHorizontalspacing(String horizontalSpacing1) {
        this.horizontalSpacing1 = horizontalSpacing1;

        js.append(String.format(Locale.US, "chart.horizontalSpacing(%s);", horizontalSpacing1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.horizontalSpacing(%s);", horizontalSpacing1));
            js.setLength(0);
        }
    }
    ...
    public Milestones getMilestones() {
        if (getmilestones == null)
            getmilestones = new Milestones("chart.milestones()");
    ...
    public void setMilestones(String milestones) {
        ...
        js.append(String.format(Locale.US, "chart.milestones(%s);", milestones));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.milestones(%s);", milestones));
            js.setLength(0);
        }
    }
    ...
    public Tasks getTasks() {
        if (gettasks == null)
            gettasks = new Tasks("chart.tasks()");
    ...
    public void setTasks(String tasks) {
        ...
        js.append(String.format(Locale.US, "chart.tasks(%s);", tasks));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.tasks(%s);", tasks));
            js.setLength(0);
        }
    }
    ...
    public void setVerticalspacing(Double verticalSpacing) {
        ...
        js.append(String.format(Locale.US, "chart.verticalSpacing(%f);", verticalSpacing));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.verticalSpacing(%f);", verticalSpacing));
            js.setLength(0);
        }
    }


    public void setVerticalspacing(String verticalSpacing1) {
        this.verticalSpacing1 = verticalSpacing1;

        js.append(String.format(Locale.US, "chart.verticalSpacing(%s);", verticalSpacing1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.verticalSpacing(%s);", verticalSpacing1));
            js.setLength(0);
        }
    }
