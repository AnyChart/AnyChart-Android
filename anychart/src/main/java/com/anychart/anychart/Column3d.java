...
public class Column3d extends WidthBased {
    ...
    public Column3d() {
        js.setLength(0);
        js.append("var column3d").append(++variableIndex).append(" = anychart.core.cartesian.series.column3d();");
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d setFill(Fill fill) {
        if (jsBase == null) {
            this.fill = fill;
        } else {
            this.fill = fill;
     ...
     * 
     */
    public Column3d setFill(String json) {
        if (jsBase == null) {
        } else {
            if (!isChain) {
                js.append(jsBase);
     ...
     */
    public Column3d fill(String color, Number opacity) {
        if (jsBase == null) {
            this.color = color;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d fill(GradientKey[] keys, Number angle, Number opacity1, Boolean mode) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d fill(GradientKey[] keys, Number angle, Number opacity1, VectorRect mode1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d fill(GradientKey[] keys, Number angle, Number opacity1, String mode2) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d fill(String[] keys1, Number angle, Number opacity1, Boolean mode) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d fill(String[] keys1, Number angle, Number opacity1, VectorRect mode1) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d fill(String[] keys1, Number angle, Number opacity1, String mode2) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d fill(GradientKey[] keys2, Number cx, Number cy, GraphicsMathRect mode3, Number opacity2, Number fx, Number fy) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            this.keys2 = null;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public Column3d fill(String[] keys3, Number cx, Number cy, GraphicsMathRect mode3, Number opacity2, Number fx, Number fy) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            this.keys2 = null;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public Column3d setStroke(Stroke color1, Number thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
     ...
     * 
     */
    public Column3d setStroke(String json) {
        if (jsBase == null) {
        } else {
            if (!isChain) {
                js.append(jsBase);
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public Column3d setStroke(ColoredFill color2, Number thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public Column3d setStroke(String color3, Number thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
