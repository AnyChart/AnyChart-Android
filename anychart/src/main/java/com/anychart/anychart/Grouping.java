...
public class Grouping extends CoreBase {
    ...
    public void setForced(Boolean forced) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".forced(%b);", forced));
    ...
    public void setLevels(String[] levels) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".levels(%s);", Arrays.toString(levels)));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".levels(%s);", Arrays.toString(levels)));
                js.setLength(0);
            }
        }
    }
    ...
    public void setMaxvisiblepoints(Double maxVisiblePoints) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".maxVisiblePoints(%f);", maxVisiblePoints));
    ...
    public void setMinpixperpoint(Double minPixPerPoint) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".minPixPerPoint(%f);", minPixPerPoint));
