...
// class
public class LineargaugePointersMarker extends JsObject {
    ...
    public void setType(String type) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".type(%s);", type));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".type(%s);", type));
                js.setLength(0);
            }
        }
    }
    ...
    public void setType(MarkerType type1) {
        if (jsBase == null) {
            this.type = null;
            this.type1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".type(%s);", (type1 != null) ? type1.generateJs() : "null"));
