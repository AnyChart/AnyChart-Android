...
public class EMA extends JsObject {
    ...
    private List<EMA> setPeriod = new ArrayList<>();
    ...
    private List<EMA> setSeries = new ArrayList<>();
    ...
    private List<EMA> setSeries1 = new ArrayList<>();
