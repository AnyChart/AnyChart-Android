...
public class GaugePointersBase extends VisualBase {
    ...
    protected GaugePointersBase(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
    ...
    public GaugePointersBase setDataIndex(Number index1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, ".dataIndex(%s)", index1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".dataIndex(%s);", index1));
                js.setLength(0);
            }
        }
        return this;
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     ...
     * 
     */
    public GaugePointersBase setFill(String json) {
        if (jsBase == null) {
        } else {
            if (!isChain) {
                js.append(jsBase);
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     * 
     */
    public GaugePointersBase setStroke(String json) {
        if (jsBase == null) {
        } else {
            if (!isChain) {
                js.append(jsBase);
