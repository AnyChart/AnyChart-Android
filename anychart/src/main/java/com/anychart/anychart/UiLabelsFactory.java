...
public class UiLabelsFactory extends JsObject {
    ...
    public void setAdjustfontsize(Boolean adjustByWidth, Boolean adjustByHeight) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".adjustFontSize(%b, %b);", adjustByWidth, adjustByHeight));
    ...
    public void setAdjustfontsize(String adjustFontSize) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".adjustFontSize(%s);", adjustFontSize));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".adjustFontSize(%s);", adjustFontSize));
                js.setLength(0);
            }
        }
    }
    ...
    public void setAdjustfontsize(Boolean[] adjustFontSize1) {
        if (jsBase == null) {
            this.adjustFontSize = null;
            this.adjustFontSize1 = null;
            this.adjustFontSize2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".adjustFontSize(%s);", Arrays.toString(adjustFontSize1)));
    ...
    public void setAdjustfontsize(Boolean adjustFontSize2) {
        if (jsBase == null) {
            this.adjustFontSize = null;
            this.adjustFontSize1 = null;
            this.adjustFontSize2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".adjustFontSize(%b);", adjustFontSize2));
    ...
    public void setConnectorstroke(Stroke color, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".connectorStroke(%s, %f, %s, %s, %s);", (color != null) ? color.generateJs() : "null", thickness, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".connectorStroke(%s, %f, %s, %s, %s);", (color != null) ? color.generateJs() : "null", thickness, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setConnectorstroke(String color1, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".connectorStroke(%s, %f, %s, %s, %s);", color1, thickness, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".connectorStroke(%s, %f, %s, %s, %s);", color1, thickness, dashpattern, (lineJoin != null) ? lineJoin.generateJs() : "null", (lineCap != null) ? lineCap.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setFormat(String token) {
        if (jsBase == null) {
            this.token = token;
        } else {
            this.token = token;

            js.append(String.format(Locale.US, jsBase + ".format(%s);", token));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".format(%s);", token));
                js.setLength(0);
            }
        }
    }
    ...
    public void setGetlabel(Double index) {
        if (jsBase == null) {
            this.index = index;
        } else {
            this.index = index;
