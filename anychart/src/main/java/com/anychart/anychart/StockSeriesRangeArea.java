...
// class
public class StockSeriesRangeArea extends JsObject {
    ...
    public void setSelectfill(GradientKey[] keys, Boolean mode, Double angle, Double opacity3) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %b, %f, %f);", arrayToString(keys), mode, angle, opacity3));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %b, %f, %f);", arrayToString(keys), mode, angle, opacity3));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectfill(GradientKey[] keys, VectorRect mode1, Double angle, Double opacity3) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %s, %f, %f);", arrayToString(keys), (mode1 != null) ? mode1.generateJs() : "null", angle, opacity3));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %s, %f, %f);", arrayToString(keys), (mode1 != null) ? mode1.generateJs() : "null", angle, opacity3));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectfill(GradientKey[] keys, String mode2, Double angle, Double opacity3) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %s, %f, %f);", arrayToString(keys), mode2, angle, opacity3));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %s, %f, %f);", arrayToString(keys), mode2, angle, opacity3));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectfill(String[] keys1, Boolean mode, Double angle, Double opacity3) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %b, %f, %f);", Arrays.toString(keys1), mode, angle, opacity3));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %b, %f, %f);", Arrays.toString(keys1), mode, angle, opacity3));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectfill(String[] keys1, VectorRect mode1, Double angle, Double opacity3) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %s, %f, %f);", Arrays.toString(keys1), (mode1 != null) ? mode1.generateJs() : "null", angle, opacity3));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %s, %f, %f);", Arrays.toString(keys1), (mode1 != null) ? mode1.generateJs() : "null", angle, opacity3));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectfill(String[] keys1, String mode2, Double angle, Double opacity3) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %s, %f, %f);", Arrays.toString(keys1), mode2, angle, opacity3));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %s, %f, %f);", Arrays.toString(keys1), mode2, angle, opacity3));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectfill(GradientKey[] keys2, Double cx, Double cy, GraphicsMathRect mode3, Double opacity4, Double fx, Double fy) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            this.keys2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %f, %f, %s, %f, %f, %f);", arrayToString(keys2), cx, cy, (mode3 != null) ? mode3.generateJs() : "null", opacity4, fx, fy));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %f, %f, %s, %f, %f, %f);", arrayToString(keys2), cx, cy, (mode3 != null) ? mode3.generateJs() : "null", opacity4, fx, fy));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSelectfill(String[] keys3, Double cx, Double cy, GraphicsMathRect mode3, Double opacity4, Double fx, Double fy) {
        if (jsBase == null) {
            this.keys = null;
            this.keys1 = null;
            this.keys2 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".selectFill(%s, %f, %f, %s, %f, %f, %f);", Arrays.toString(keys3), cx, cy, (mode3 != null) ? mode3.generateJs() : "null", opacity4, fx, fy));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectFill(%s, %f, %f, %s, %f, %f, %f);", Arrays.toString(keys3), cx, cy, (mode3 != null) ? mode3.generateJs() : "null", opacity4, fx, fy));
                js.setLength(0);
            }
        }
    }
