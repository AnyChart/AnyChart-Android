...
public class TableColumn extends TableBase {
    ...
    public void setCellborder(Stroke color3, Double thickness1, String dashpattern1, StrokeLineJoin lineJoin1, StrokeLineCap lineCap1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".cellBorder(%s, %f, %s, %s, %s);", (color3 != null) ? color3.generateJs() : "null", thickness1, dashpattern1, (lineJoin1 != null) ? lineJoin1.generateJs() : "null", (lineCap1 != null) ? lineCap1.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".cellBorder(%s, %f, %s, %s, %s);", (color3 != null) ? color3.generateJs() : "null", thickness1, dashpattern1, (lineJoin1 != null) ? lineJoin1.generateJs() : "null", (lineCap1 != null) ? lineCap1.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setCellborder(ColoredFill color4, Double thickness1, String dashpattern1, StrokeLineJoin lineJoin1, StrokeLineCap lineCap1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".cellBorder(%s, %f, %s, %s, %s);", (color4 != null) ? color4.generateJs() : "null", thickness1, dashpattern1, (lineJoin1 != null) ? lineJoin1.generateJs() : "null", (lineCap1 != null) ? lineCap1.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".cellBorder(%s, %f, %s, %s, %s);", (color4 != null) ? color4.generateJs() : "null", thickness1, dashpattern1, (lineJoin1 != null) ? lineJoin1.generateJs() : "null", (lineCap1 != null) ? lineCap1.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setCellborder(String color5, Double thickness1, String dashpattern1, StrokeLineJoin lineJoin1, StrokeLineCap lineCap1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".cellBorder(%s, %f, %s, %s, %s);", color5, thickness1, dashpattern1, (lineJoin1 != null) ? lineJoin1.generateJs() : "null", (lineCap1 != null) ? lineCap1.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".cellBorder(%s, %f, %s, %s, %s);", color5, thickness1, dashpattern1, (lineJoin1 != null) ? lineJoin1.generateJs() : "null", (lineCap1 != null) ? lineCap1.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setCellfill(String color6, Double opacity) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".cellFill(%s, %f);", color6, opacity));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".cellFill(%s, %f);", color6, opacity));
                js.setLength(0);
            }
        }
    }
    ...
    public void setGetcell(Double row) {
        if (jsBase == null) {
            this.row = row;
        } else {
            this.row = row;
    ...
    public void setMaxwidth(String maxWidth) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".maxWidth(%s);", maxWidth));
    ...
    public void setMaxwidth(Double maxWidth1) {
        if (jsBase == null) {
            this.maxWidth = null;
            this.maxWidth1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".maxWidth(%f);", maxWidth1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".maxWidth(%f);", maxWidth1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setMinwidth(String minWidth) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".minWidth(%s);", minWidth));
    ...
    public void setMinwidth(Double minWidth1) {
        if (jsBase == null) {
            this.minWidth = null;
            this.minWidth1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".minWidth(%f);", minWidth1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".minWidth(%f);", minWidth1));
                js.setLength(0);
            }
        }
    }
    ...
    protected String generateJs() {
        if (jsBase == null) {
            ...
            js.append(generateJSgetMaxWidth());
