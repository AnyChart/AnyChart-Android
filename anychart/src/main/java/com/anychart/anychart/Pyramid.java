...
public class Pyramid extends Chart {

    public Pyramid() {
        js.append("chart = anychart.pyramid();");
    }
    ...
    public void setReversed(Boolean reversed) {
        ...
        js.append(String.format(Locale.US, "chart.reversed(%b);", reversed));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.reversed(%b);", reversed));
            js.setLength(0);
        }
    }
