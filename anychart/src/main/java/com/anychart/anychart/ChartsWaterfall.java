...
<b>Note:</b> Works only after {@link anychart.charts.Waterfall#draw} is called.
     ...
     */
    public ChartsWaterfall setMaxLabels(String settings) {
        if (!isChain) {
            js.append(jsBase);
            isChain = true;
        }
     ...
     * Setter for maximum labels.
     */
    public ChartsWaterfall setMaxLabels(Boolean settings1) {
        if (!isChain) {
            js.append(jsBase);
            isChain = true;
        }
     ...
     */
    public ChartsWaterfall setMinLabels(String settings2) {
        if (!isChain) {
            js.append(jsBase);
            isChain = true;
        }
     ...
     * Setter for minimum labels.
     */
    public ChartsWaterfall setMinLabels(Boolean settings3) {
        if (!isChain) {
            js.append(jsBase);
            isChain = true;
        }
