...
public class RoC extends JsObject {
    ...
    private List<RoC> setPeriod = new ArrayList<>();
    ...
    private List<RoC> setSeries = new ArrayList<>();
    ...
    private List<RoC> setSeries1 = new ArrayList<>();
