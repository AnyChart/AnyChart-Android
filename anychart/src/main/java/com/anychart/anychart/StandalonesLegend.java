...
public class StandalonesLegend extends JsObject {
    ...
    public void setItemssource(SeparateChart itemsSource) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".itemsSource(%s);", (itemsSource != null) ? itemsSource.generateJs() : "null"));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".itemsSource(%s);", (itemsSource != null) ? itemsSource.generateJs() : "null"));
                js.setLength(0);
            }
        }
    }
    ...
    public void setItemssource(SeparateChart[] itemsSource1) {
        if (jsBase == null) {
            this.itemsSource = null;
            this.itemsSource1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".itemsSource(%s);", arrayToString(itemsSource1)));
    ...
    public void setParentbounds(Double left, Double top, Double width, Double height2) {
        if (jsBase == null) {
            this.left = left;
            this.top = top;
            this.width = width;
            ...
            js.append(String.format(Locale.US, jsBase + ".parentBounds(%f, %f, %f, %f);", left, top, width, height2));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".parentBounds(%f, %f, %f, %f);", left, top, width, height2));
                js.setLength(0);
            }
        }
    }
    ...
    public void setWidth(String width2) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".width(%s);", width2));
