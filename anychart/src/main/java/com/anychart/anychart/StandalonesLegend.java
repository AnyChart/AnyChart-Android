...
public class StandalonesLegend extends JsObject {
    ...
    public void setMargin(Double margin2) {
        this.margin = null;
        this.margin1 = null;
        this.margin2 = null;
        this.margin3 = null;
    ...
    public void setMargin(String margin3) {
        this.margin = null;
        this.margin1 = null;
        this.margin2 = null;
        this.margin3 = null;
    ...
    public void setTitleseparator(Boolean titleSeparator) {
    ...
    private String generateJSmargin2() {
        if (margin2 != null) {
            return String.format(Locale.US, "margin: %f,", margin2);
        }
        return "";
    }
    ...
    private String generateJSpadding2() {
        if (padding2 != null) {
            return String.format(Locale.US, "padding: %f,", padding2);
        }
        return "";
    }
    ...
    private String generateJSpaginator() {
        if (paginator != null) {
            return String.format(Locale.US, "paginator: %b,", paginator);
        }
        return "";
    }
    ...
    private String generateJStitleSeparator() {
        if (titleSeparator != null) {
            return String.format(Locale.US, "titleSeparator: %b,", titleSeparator);
        }
        return "";
    }
