...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public Ray setStroke(Stroke color, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public Ray setStroke(ColoredFill color1, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     */
    public Ray setStroke(String color2, Double thickness, String dashpattern, StrokeLineJoin lineJoin, StrokeLineCap lineCap) {
        if (jsBase == null) {
            this.color = null;
            this.color1 = null;
            this.color2 = null;
