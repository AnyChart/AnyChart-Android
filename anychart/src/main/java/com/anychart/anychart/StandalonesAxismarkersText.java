...
public class StandalonesAxismarkersText extends CoreAxismarkersText {
    ...
    private List<StandalonesAxismarkersText> setContainer = new ArrayList<>();
    ...
    private String generateJSsetContainer() {
        if (!setContainer.isEmpty()) {
            ...
            for (StandalonesAxismarkersText item : setContainer) {
    ...
    private List<StandalonesAxismarkersText> setContainer1 = new ArrayList<>();
    ...
    private String generateJSsetContainer1() {
        if (!setContainer1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StandalonesAxismarkersText item : setContainer1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StandalonesAxismarkersText> setContainer2 = new ArrayList<>();
    ...
    private String generateJSsetContainer2() {
        if (!setContainer2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StandalonesAxismarkersText item : setContainer2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StandalonesAxismarkersText> setContainer3 = new ArrayList<>();
    ...
    private String generateJSsetContainer3() {
        if (!setContainer3.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StandalonesAxismarkersText item : setContainer3) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StandalonesAxismarkersText> setParentBounds = new ArrayList<>();
    ...
    private String generateJSsetParentBounds() {
        if (!setParentBounds.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StandalonesAxismarkersText item : setParentBounds) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StandalonesAxismarkersText> setParentBounds1 = new ArrayList<>();
    ...
    private String generateJSsetParentBounds1() {
        if (!setParentBounds1.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StandalonesAxismarkersText item : setParentBounds1) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
    ...
    private List<StandalonesAxismarkersText> setParentBounds2 = new ArrayList<>();
    ...
    private String generateJSsetParentBounds2() {
        if (!setParentBounds2.isEmpty()) {
            StringBuilder resultJs = new StringBuilder();
            for (StandalonesAxismarkersText item : setParentBounds2) {
                resultJs.append(item.generateJs());
            }
            return resultJs.toString();
        }
