...
public class ScrollerseriesArea extends JsObject {
    ...
    private Boolean patternFillOrType8;
    ...
    public void setSelecthatchfill(Boolean patternFillOrType8, String color3, Double thickness1, Double size1) {
        this.patternFillOrType = null;
        this.patternFillOrType1 = null;
        this.patternFillOrType2 = null;
        this.patternFillOrType3 = null;
    ...
    private String generateJSpatternFillOrType8() {
        if (patternFillOrType8 != null) {
            return String.format(Locale.US, "patternFillOrType: %b,", patternFillOrType8);
        }
        return "";
    }
