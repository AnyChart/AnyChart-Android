...
public class ScrollerseriesArea extends ScrollerseriesBase {
    ...
    public void setSelecthatchfill(Boolean patternFillOrType8, String color3, Double thickness1, Double size1) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".selectHatchFill(%b, %s, %f, %f);", patternFillOrType8, color3, thickness1, size1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".selectHatchFill(%b, %s, %f, %f);", patternFillOrType8, color3, thickness1, size1));
                js.setLength(0);
            }
        }
    }
