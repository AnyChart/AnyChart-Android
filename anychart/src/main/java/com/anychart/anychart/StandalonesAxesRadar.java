 ...
 */
public class StandalonesAxesRadar extends CoreAxesRadar {

    public StandalonesAxesRadar() {
        js.setLength(0);
        js.append("var standalonesAxesRadar").append(++variableIndex).append(" = anychart.standalones.axes.radar();");
        jsBase = "standalonesAxesRadar" + variableIndex;
    }

    protected StandalonesAxesRadar(String jsBase) {
        js.setLength(0);
        this.jsBase = jsBase;
    }

    protected StandalonesAxesRadar(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
     ...
     */
    public StandalonesAxesRadar setContainer(Layer container) {
        if (jsBase == null) {
            this.container = null;
     ...
     * Setter for the axis container.
     */
    public StandalonesAxesRadar setContainer(Stage container1) {
        if (jsBase == null) {
            this.container = null;
            this.container1 = null;
            this.container2 = null;
     ...
     * Setter for the axis container.
     */
    public StandalonesAxesRadar setContainer(String container2) {
        if (jsBase == null) {
            this.container = null;
            this.container1 = null;
            this.container2 = null;
     ...
     * Setter for the axis container.
     */
    public StandalonesAxesRadar setContainer(Element container3) {
        if (jsBase == null) {
            this.container = null;
            this.container1 = null;
            this.container2 = null;
     ...
     */
    public StandalonesAxesRadar setParentBounds(AnychartMathRect parentBounds) {
        if (jsBase == null) {
     ...
     * Setter for bounds using single value.
     */
    public StandalonesAxesRadar setParentBounds(String parentBounds1) {
        if (jsBase == null) {
            this.parentBounds = null;
            this.parentBounds1 = null;
     ...
     */
    public StandalonesAxesRadar setParentBounds(Number left, Number top, Number width, Number height) {
        if (jsBase == null) {
            this.left = left;
            this.top = top;
            this.width = width;
     ...
     */
    public StandalonesAxesRadar setStartAngle(String startAngle) {
        if (jsBase == null) {
     ...
     * Setter for a start angle.
     */
    public StandalonesAxesRadar setStartAngle(Number startAngle1) {
        if (jsBase == null) {
            this.startAngle = null;
            this.startAngle1 = null;
