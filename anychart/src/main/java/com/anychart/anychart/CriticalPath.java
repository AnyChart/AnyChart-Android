...
public class CriticalPath extends JsObject {
    ...
    public void setMilestones(String milestones) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".milestones(%s);", milestones));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".milestones(%s);", milestones));
                js.setLength(0);
            }
        }
    }
    ...
    public void setTasks(String tasks) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".tasks(%s);", tasks));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".tasks(%s);", tasks));
                js.setLength(0);
            }
        }
    }
