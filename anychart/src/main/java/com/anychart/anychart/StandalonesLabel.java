...
public class StandalonesLabel extends JsObject {
    ...
    private Boolean[] bothOrByWidth;
    private Boolean bothOrByWidth1;
    private Boolean byHeight;

    public void setAdjustfontsize(Boolean[] bothOrByWidth, Boolean byHeight) {
    ...
    private String generateJSbothOrByWidth() {
        if (bothOrByWidth != null) {
            return String.format(Locale.US, "bothOrByWidth: %s,", Arrays.toString(bothOrByWidth));
        }
        return "";
    }
    ...
    private String generateJSbothOrByWidth1() {
        if (bothOrByWidth1 != null) {
            return String.format(Locale.US, "bothOrByWidth: %b,", bothOrByWidth1);
        }
        return "";
    }
