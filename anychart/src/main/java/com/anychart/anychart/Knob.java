...
public class Knob extends JsObject {
    ...
    public void setBottomradius(Double bottomRadius) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".bottomRadius(%f);", bottomRadius));
    ...
    public void setBottomradius(String bottomRadius1) {
        if (jsBase == null) {
            this.bottomRadius = null;
            this.bottomRadius1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".bottomRadius(%s);", bottomRadius1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".bottomRadius(%s);", bottomRadius1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setBottomratio(Double bottomRatio) {
        if (jsBase == null) {
            this.bottomRatio = bottomRatio;
        } else {
            this.bottomRatio = bottomRatio;

            js.append(String.format(Locale.US, jsBase + ".bottomRatio(%f);", bottomRatio));
    ...
    public void setTopradius(Double topRadius) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".topRadius(%f);", topRadius));
    ...
    public void setTopradius(String topRadius1) {
        if (jsBase == null) {
            this.topRadius = null;
            this.topRadius1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".topRadius(%s);", topRadius1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".topRadius(%s);", topRadius1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setTopratio(Double topRatio) {
        if (jsBase == null) {
            this.topRatio = topRatio;
        } else {
            this.topRatio = topRatio;

            js.append(String.format(Locale.US, jsBase + ".topRatio(%f);", topRatio));
    ...
    public void setVerticescount(Double verticesCount) {
        if (jsBase == null) {
            this.verticesCount = verticesCount;
        } else {
            this.verticesCount = verticesCount;

            js.append(String.format(Locale.US, jsBase + ".verticesCount(%f);", verticesCount));
    ...
    public void setVerticescurvature(Double verticesCurvature) {
        if (jsBase == null) {
            this.verticesCurvature = verticesCurvature;
        } else {
            this.verticesCurvature = verticesCurvature;

            js.append(String.format(Locale.US, jsBase + ".verticesCurvature(%f);", verticesCurvature));
