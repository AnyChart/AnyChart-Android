...
public class StandalonesAxismarkersLine extends CoreAxismarkersLine {
    ...
    public StandalonesAxismarkersLine() {
        js.setLength(0);
        js.append("var standalonesAxismarkersLine").append(++variableIndex).append(" = anychart.standalones.axisMarkers.line();");
        jsBase = "standalonesAxismarkersLine" + variableIndex;
    }
    ...
    protected StandalonesAxismarkersLine(StringBuilder js, String jsBase, boolean isChain) {
        this.js = js;
        this.jsBase = jsBase;
     ...
     */
    public StandalonesAxismarkersLine setParentBounds(AnychartMathRect parentBounds) {
        if (jsBase == null) {
     ...
     * Setter for bounds using single value.
     */
    public StandalonesAxismarkersLine setParentBounds(String parentBounds1) {
        if (jsBase == null) {
            this.parentBounds = null;
            this.parentBounds1 = null;
