...
public class Image extends JsObject {
    ...
    public void setFittingmode(Fitting fittingMode) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".fittingMode(%s);", (fittingMode != null) ? fittingMode.generateJs() : "null"));
    ...
    public void setFittingmode(String fittingMode1) {
        if (jsBase == null) {
            this.fittingMode = null;
            this.fittingMode1 = null;
            ...
            js.append(String.format(Locale.US, jsBase + ".fittingMode(%s);", fittingMode1));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".fittingMode(%s);", fittingMode1));
                js.setLength(0);
            }
        }
    }
    ...
    public void setSrc(String src) {
        if (jsBase == null) {
            ...
            js.append(String.format(Locale.US, jsBase + ".src(%s);", src));

            if (isRendered) {
                onChangeListener.onChange(String.format(Locale.US, jsBase + ".src(%s);", src));
                js.setLength(0);
            }
        }
    }
