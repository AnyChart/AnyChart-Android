...
public class AnyChart {
    ...
    public static ChartsMekko barmekko() {
        return new ChartsMekko("anychart.barmekko");
    }
    ...
    public static ChartsMap bubbleMap() {
        return new ChartsMap("anychart.bubbleMap");
    }
    ...
    public static ChartsMap choropleth() {
        return new ChartsMap("anychart.choropleth");
    }
    ...
    public static ChartsMap connector() {
        return new ChartsMap("anychart.connector");
    }
    ...
    public static ChartsMap map() {
        return new ChartsMap("anychart.map");
    }
    ...
    public static ChartsMap markerMap() {
        return new ChartsMap("anychart.markerMap");
    }

    public static ChartsMekko mekko() {
        return new ChartsMekko("anychart.mekko");
    }

    public static ChartsMekko mosaic() {
        return new ChartsMekko("anychart.mosaic");
    }
    ...
    public static ChartsPolar polar() {
        return new ChartsPolar("anychart.polar");
    }
    ...
    public static ChartsRadar radar() {
        return new ChartsRadar("anychart.radar");
    }
    ...
    public static ChartsMap seatMap() {
        return new ChartsMap("anychart.seatMap");
    }
    ...
    public static ChartsStock stock() {
    ...
    public static ChartsWaterfall waterfall() {
        return new ChartsWaterfall("anychart.waterfall");
    }
    ...
    public static ChartsLinearGauge led() {
        return new ChartsLinearGauge("anychart.gauges.led");
    }

    public static ChartsLinearGauge linear() {
        return new ChartsLinearGauge("anychart.gauges.linear");
    }

    public static ChartsLinearGauge tank() {
        return new ChartsLinearGauge("anychart.gauges.tank");
    }

    public static ChartsLinearGauge thermometer() {
        return new ChartsLinearGauge("anychart.gauges.thermometer");
    }
