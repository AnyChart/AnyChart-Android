...
public class TreeMap extends Chart {
    ...
    public void setColorscale(LinearColor colorScale1) {
    ...
    public void setDrillto(DataItem target) {
        this.target = target;

        js.append(String.format(Locale.US, "chart.drillTo(%s);", (target != null) ? target.generateJs() : "null"));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.drillTo(%s);", (target != null) ? target.generateJs() : "null"));
            js.setLength(0);
        }
    }


    public void setDrillto(String[] target1) {
        this.target1 = target1;

        js.append(String.format(Locale.US, "chart.drillTo(%s);", Arrays.toString(target1)));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.drillTo(%s);", Arrays.toString(target1)));
            js.setLength(0);
        }
    }


    public void setDrillto(String target2) {
        this.target2 = target2;

        js.append(String.format(Locale.US, "chart.drillTo(\"%s\");", target2));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.drillTo(\"%s\");", target2));
            js.setLength(0);
        }
    }
    ...
    public void setHeadersdisplaymode(String headersDisplayMode) {
        this.headersDisplayMode = headersDisplayMode;

        js.append(String.format(Locale.US, "chart.headersDisplayMode(\"%s\");", headersDisplayMode));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.headersDisplayMode(\"%s\");", headersDisplayMode));
            js.setLength(0);
        }
    }


    public void setHeadersdisplaymode(LabelsDisplayMode headersDisplayMode1) {
        this.headersDisplayMode1 = headersDisplayMode1;

        js.append(String.format(Locale.US, "chart.headersDisplayMode(%s);", (headersDisplayMode1 != null) ? headersDisplayMode1.generateJs() : "null"));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.headersDisplayMode(%s);", (headersDisplayMode1 != null) ? headersDisplayMode1.generateJs() : "null"));
            js.setLength(0);
        }
    }
    ...
    public void setHintdepth(Double hintDepth) {
        this.hintDepth = hintDepth;

        js.append(String.format(Locale.US, "chart.hintDepth(%f);", hintDepth));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.hintDepth(%f);", hintDepth));
            js.setLength(0);
        }
    }
    ...
    public void setHintopacity(Double hintOpacity) {
        this.hintOpacity = hintOpacity;

        js.append(String.format(Locale.US, "chart.hintOpacity(%f);", hintOpacity));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.hintOpacity(%f);", hintOpacity));
            js.setLength(0);
        }
    }
    ...
    private Stroke strokeFunction;

    public void setHoverstroke(Stroke strokeFunction) {
        this.strokeFunction = strokeFunction;

        js.append(String.format(Locale.US, "chart.hoverStroke(%s);", (strokeFunction != null) ? strokeFunction.generateJs() : "null"));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.hoverStroke(%s);", (strokeFunction != null) ? strokeFunction.generateJs() : "null"));
            js.setLength(0);
        }
    }
    ...
    public void setMaxdepth(Double maxDepth) {
        ...
        js.append(String.format(Locale.US, "chart.maxDepth(%f);", maxDepth));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.maxDepth(%f);", maxDepth));
            js.setLength(0);
        }
    }
    ...
    public void setMaxheadersheight(Double maxHeadersHeight) {
        this.maxHeadersHeight = maxHeadersHeight;

        js.append(String.format(Locale.US, "chart.maxHeadersHeight(%f);", maxHeadersHeight));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.maxHeadersHeight(%f);", maxHeadersHeight));
            js.setLength(0);
        }
    }


    public void setMaxheadersheight(String maxHeadersHeight1) {
        this.maxHeadersHeight1 = maxHeadersHeight1;

        js.append(String.format(Locale.US, "chart.maxHeadersHeight(\"%s\");", maxHeadersHeight1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.maxHeadersHeight(\"%s\");", maxHeadersHeight1));
            js.setLength(0);
        }
    }
    ...
    public void setSaveasjpg(Double width2, Double height4, Double quality, Boolean forceTransparentWhite, String filename) {
        this.width2 = width2;
        ...
        js.append(String.format(Locale.US, "chart.saveAsJpg(%f, %f, %f, %b, \"%s\");", width2, height4, quality, forceTransparentWhite, filename));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.saveAsJpg(%f, %f, %f, %b, \"%s\");", width2, height4, quality, forceTransparentWhite, filename));
            js.setLength(0);
        }
    }
    ...
    public void setSaveaspdf(Double paperSizeOrWidthOrOptions, Boolean landscape1, Double x2, Double y2, String filename1) {
        ...
        js.append(String.format(Locale.US, "chart.saveAsPdf(%f, %b, %f, %f, \"%s\");", paperSizeOrWidthOrOptions, landscape1, x2, y2, filename1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.saveAsPdf(%f, %b, %f, %f, \"%s\");", paperSizeOrWidthOrOptions, landscape1, x2, y2, filename1));
            js.setLength(0);
        }
    }


    public void setSaveaspdf(String paperSizeOrWidthOrOptions1, Boolean landscape1, Double x2, Double y2, String filename1) {
        ...
        js.append(String.format(Locale.US, "chart.saveAsPdf(\"%s\", %b, %f, %f, \"%s\");", paperSizeOrWidthOrOptions1, landscape1, x2, y2, filename1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.saveAsPdf(\"%s\", %b, %f, %f, \"%s\");", paperSizeOrWidthOrOptions1, landscape1, x2, y2, filename1));
            js.setLength(0);
        }
    }
    ...
    public void setSaveassvg(String paperSize, Boolean landscape2, String filename3) {
        this.paperSize = paperSize;
        this.landscape2 = landscape2;
        this.filename3 = filename3;

        js.append(String.format(Locale.US, "chart.saveAsSvg(\"%s\", %b, \"%s\");", paperSize, landscape2, filename3));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.saveAsSvg(\"%s\", %b, \"%s\");", paperSize, landscape2, filename3));
            js.setLength(0);
        }
    }
    ...
    public void setSelectmarqueefill(GradientKey[] keys12, Rect mode10, Double angle3, Double opacity10) {
        this.keys12 = keys12;
        this.mode10 = mode10;
        this.angle3 = angle3;
        this.opacity10 = opacity10;
    ...
    public void setSelectmarqueefill(String[] keys13, Rect mode10, Double angle3, Double opacity10) {
        this.keys13 = keys13;
        this.mode10 = mode10;
        this.angle3 = angle3;
        this.opacity10 = opacity10;
    ...
    public void setSelectmarqueefill(GradientKey[] keys14, Double cx3, Double cy3, Rect mode11, Double opacity11, Double fx3, Double fy3) {
        this.keys14 = keys14;
        this.cx3 = cx3;
        this.cy3 = cy3;
        this.mode11 = mode11;
    ...
    public void setSelectmarqueefill(String[] keys15, Double cx3, Double cy3, Rect mode11, Double opacity11, Double fx3, Double fy3) {
        this.keys15 = keys15;
        this.cx3 = cx3;
        this.cy3 = cy3;
        this.mode11 = mode11;
    ...
    public void setSelectionmode(SelectionMode selectionMode) {
        ...
        js.append(String.format(Locale.US, "chart.selectionMode(%s);", (selectionMode != null) ? selectionMode.generateJs() : "null"));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.selectionMode(%s);", (selectionMode != null) ? selectionMode.generateJs() : "null"));
            js.setLength(0);
        }
    }
    ...
    public void setSelectionmode(String selectionMode1) {
        ...
        js.append(String.format(Locale.US, "chart.selectionMode(\"%s\");", selectionMode1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.selectionMode(\"%s\");", selectionMode1));
            js.setLength(0);
        }
    }
    ...
    public void setTojson(Boolean stringify, Boolean includeTheme) {
        ...
        js.append(String.format(Locale.US, "chart.toJson(%b, %b);", stringify, includeTheme));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.toJson(%b, %b);", stringify, includeTheme));
            js.setLength(0);
        }
    }
    ...
    public void setToxml(Boolean asXmlNode, Boolean includeTheme1) {
        ...
        js.append(String.format(Locale.US, "chart.toXml(%b, %b);", asXmlNode, includeTheme1));

        if (isRendered) {
            onChangeListener.onChange(String.format(Locale.US, "chart.toXml(%b, %b);", asXmlNode, includeTheme1));
            js.setLength(0);
        }
    }
