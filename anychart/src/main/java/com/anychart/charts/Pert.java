...
public class Pert extends SeparateChart {
     ...
     */
    public com.anychart.charts.Pert animation(Boolean value) {
     ...
     * Setter for animation settings by one value.
     */
    public com.anychart.charts.Pert animation(String value) {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public com.anychart.charts.Pert autoRedraw(Boolean value) {
     ...
     */
    public com.anychart.charts.Pert background(String value) {
     ...
     */
    public com.anychart.charts.Pert bottom(Number value) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.charts.Pert bottom(String value) {
     ...
     */
    public com.anychart.charts.Pert bounds(com.anychart.utils.RectObj value) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.Pert bounds(com.anychart.math.Rect value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (value != null) ? value.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.charts.Pert bounds(com.anychart.core.utils.Bounds value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (value != null) ? value.getJsBase() : null));
     ...
     */
    public com.anychart.charts.Pert container(com.anychart.graphics.vector.Layer value) {
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.Pert container(com.anychart.graphics.vector.Stage value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (value != null) ? value.getJsBase() : null));
     ...
     * Setter for the element's container.
     */
    public com.anychart.charts.Pert container(String value) {
     ...
     */
    public com.anychart.charts.Pert contextMenu(String value) {
     ...
     * Setter for the context menu.
     */
    public com.anychart.charts.Pert contextMenu(Boolean value) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     ...
     */
    public com.anychart.charts.Pert criticalPath(String value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".criticalPath(%s);", wrapQuotes(value)));
     ...
     */
    public com.anychart.charts.Pert enabled(Boolean value) {
     ...
     */
    public com.anychart.charts.Pert expectedTimeCalculator(String value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".expectedTimeCalculator(%s);", wrapQuotes(value)));
     ...
     */
    public com.anychart.charts.Pert exports(String value) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public com.anychart.charts.Pert height(Number value) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.charts.Pert height(String value) {
     ...
     */
    public com.anychart.charts.Pert horizontalSpacing(Number value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".horizontalSpacing(%s);", value));
     ...
     * Setter for milestones horizontal spacing.
     */
    public com.anychart.charts.Pert horizontalSpacing(String value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".horizontalSpacing(%s);", wrapQuotes(value)));
     ...
     */
    public com.anychart.charts.Pert interactivity(String value) {
     ...
     * Setter for interactivity settings for the chart.
     */
    public com.anychart.charts.Pert interactivity(com.anychart.enums.HoverMode value) {
     ...
     */
    public com.anychart.charts.Pert label(Boolean value) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pert label(String index, Boolean value) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pert label(String index, String value) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pert label(Number index, Boolean value) {
     ...
     * Setter for the chart label.
     */
    public com.anychart.charts.Pert label(Number index, String value) {
     ...
     */
    public com.anychart.charts.Pert left(Number value) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.charts.Pert left(String value) {
     ...
     */
    public com.anychart.charts.Pert legend(String value) {
     ...
     * Setter for chart legend settings.
     */
    public com.anychart.charts.Pert legend(Boolean value) {
...
<img src='/si/8.2.1/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.Pert margin(Number[] value) {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public com.anychart.charts.Pert margin(String[] value) {
     ...
     */
    public com.anychart.charts.Pert maxHeight(Number value) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.charts.Pert maxHeight(String value) {
     ...
     */
    public com.anychart.charts.Pert maxWidth(Number value) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.charts.Pert maxWidth(String value) {
     ...
     */
    public com.anychart.charts.Pert milestones(String value) {
     ...
     */
    public com.anychart.charts.Pert minHeight(Number value) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.charts.Pert minHeight(String value) {
     ...
     */
    public com.anychart.charts.Pert minWidth(Number value) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.charts.Pert minWidth(String value) {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public com.anychart.charts.Pert noData(String value) {
...
<img src='/si/8.2.1/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public com.anychart.charts.Pert padding(Number[] value) {
     ...
     * Setter for the chart paddings in pixels using a single value.
     */
    public com.anychart.charts.Pert padding(String[] value) {
     ...
     */
    public com.anychart.charts.Pert right(Number value) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.charts.Pert right(String value) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.charts.Pert selectMarqueeFill(com.anychart.graphics.vector.Fill value) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public com.anychart.charts.Pert tasks(String value) {
     ...
     */
    public com.anychart.charts.Pert title(Boolean value) {
     ...
     * Setter for the chart title.
     */
    public com.anychart.charts.Pert title(String value) {
     ...
     */
    public com.anychart.charts.Pert top(Number value) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.charts.Pert top(String value) {
     ...
     */
    public com.anychart.charts.Pert verticalSpacing(Number value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".verticalSpacing(%s);", value));
     ...
     * Setter for milestones vertical spacing.
     */
    public com.anychart.charts.Pert verticalSpacing(String value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".verticalSpacing(%s);", wrapQuotes(value)));
     ...
     */
    public com.anychart.charts.Pert width(Number value) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.charts.Pert width(String value) {
     ...
     */
    public com.anychart.charts.Pert zIndex(Number value) {
     ...
     */
    public com.anychart.charts.Pert a11y(Boolean value) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.charts.Pert a11y(String value) {
     ...
     */
    public com.anychart.charts.Pert tooltip(String tooltipSettings) {
     ...
     * Setter for the chart tooltip.
     */
    public com.anychart.charts.Pert tooltip(Boolean tooltipSettings) {
