...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.anychart.graphics.vector.Element id(String value) {
     ...
     */
    public com.anychart.graphics.vector.Element parent(com.anychart.graphics.vector.Layer value) {
     ...
     * Adds element to the given layer.
     */
    public com.anychart.graphics.vector.Element parent(com.anychart.graphics.vector.Stage value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (value != null) ? value.getJsBase() : null));
