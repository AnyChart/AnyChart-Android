...
Read more at {@link anychart.graphics.vector.primitives#hLine}
     ...
     */
    public com.anychart.graphics.vector.PatternFill id(String id) {
...
You have to take care of used objects yourself.
     ...
     */
    public com.anychart.graphics.vector.PatternFill parent(com.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.anychart.graphics.vector.PatternFill parent(com.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
