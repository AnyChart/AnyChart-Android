...
public class Shape extends Element {
    ...
    public Shape(String jsChart) {
        jsBase = "shape" + ++variableIndex;
     ...
     */
    public com.anychart.graphics.vector.Shape appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.anychart.graphics.vector.Shape attr(String key, String value) {
     ...
     */
    public com.anychart.graphics.vector.Shape clip(com.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.anychart.graphics.vector.Shape clip(String value) {
     ...
     */
    public com.anychart.graphics.vector.Shape cursor(com.anychart.graphics.vector.Cursor value) {
     ...
     */
    public com.anychart.graphics.vector.Shape desc(String value) {
     ...
     */
    public com.anychart.graphics.vector.Shape disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.anychart.graphics.vector.Shape disableStrokeScaling(Boolean value) {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public com.anychart.graphics.vector.Shape drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.anychart.graphics.vector.Shape drag(com.anychart.graphics.math.Rect value) {
     ...
     */
    public com.anychart.graphics.vector.Shape fill(com.anychart.graphics.vector.Fill color) {
     ...
     */
    public com.anychart.graphics.vector.Shape fill(String color, Number opacity) {
     ...
     */
    public com.anychart.graphics.vector.Shape fill(com.anychart.graphics.vector.GradientKey keys, Number angle, Boolean mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.anychart.graphics.vector.Shape fill(com.anychart.graphics.vector.GradientKey keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.anychart.graphics.vector.Shape fill(com.anychart.graphics.vector.GradientKey keys, Number angle, String mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.anychart.graphics.vector.Shape fill(String[] keys, Number angle, Boolean mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.anychart.graphics.vector.Shape fill(String[] keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
     ...
     * Linear gradient fill.
     */
    public com.anychart.graphics.vector.Shape fill(String[] keys, Number angle, String mode, Number opacity) {
     ...
     */
    public com.anychart.graphics.vector.Shape fill(com.anychart.graphics.vector.GradientKey keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
     ...
     * Radial gradient fill.
     */
    public com.anychart.graphics.vector.Shape fill(String[] keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.anychart.graphics.vector.Shape id(String id) {
     ...
     */
    public com.anychart.graphics.vector.Shape parent(com.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.anychart.graphics.vector.Shape parent(com.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
     ...
     */
    public com.anychart.graphics.vector.Shape remove() {
     ...
     */
    public com.anychart.graphics.vector.Shape rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.anychart.graphics.vector.Shape rotateByAnchor(Number degrees, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Shape rotateByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.anychart.graphics.vector.Shape scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.anychart.graphics.vector.Shape scaleByAnchor(Number sx, Number sy, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.anychart.graphics.vector.Shape scaleByAnchor(Number sx, Number sy, String anchor) {
     ...
     */
    public com.anychart.graphics.vector.Shape setPosition(Number x, Number y) {
     ...
     */
    public com.anychart.graphics.vector.Shape setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Shape setRotationByAnchor(Number degrees, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Shape setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.anychart.graphics.vector.Shape setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.Stroke value) {
     ...
     * Sets a stroke using one parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.ColoredFill value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s);", (value != null) ? value.getJsBase() : null));
     ...
     * Sets a stroke using one parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(String value) {
     ...
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.Stroke value, Number thickness, String dashpattern, String lineJoin, String lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.Stroke value, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.Stroke value, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.Stroke value, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.ColoredFill value, Number thickness, String dashpattern, String lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != null) ? value.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), wrapQuotes(lineCap)));
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.ColoredFill value, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != null) ? value.getJsBase() : null, thickness, wrapQuotes(dashpattern), wrapQuotes(lineJoin), (lineCap != null) ? lineCap.getJsBase() : null));
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.ColoredFill value, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != null) ? value.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, wrapQuotes(lineCap)));
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(com.anychart.graphics.vector.ColoredFill value, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".stroke(%s, %s, %s, %s, %s);", (value != null) ? value.getJsBase() : null, thickness, wrapQuotes(dashpattern), (lineJoin != null) ? lineJoin.getJsBase() : null, (lineCap != null) ? lineCap.getJsBase() : null));
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(String value, Number thickness, String dashpattern, String lineJoin, String lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(String value, Number thickness, String dashpattern, String lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(String value, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, String lineCap) {
     ...
     * Sets stroke settings using several parameter.
     */
    public com.anychart.graphics.vector.Shape stroke(String value, Number thickness, String dashpattern, com.anychart.graphics.vector.StrokeLineJoin lineJoin, com.anychart.graphics.vector.StrokeLineCap lineCap) {
     ...
     */
    public com.anychart.graphics.vector.Shape strokeThickness(Number thickness) {
     ...
     */
    public com.anychart.graphics.vector.Shape title(String value) {
     ...
     */
    public com.anychart.graphics.vector.Shape translate(Number tx, Number ty) {
     ...
     */
    public com.anychart.graphics.vector.Shape visible(Boolean isVisible) {
     ...
     */
    public com.anychart.graphics.vector.Shape zIndex(Number value) {
     ...
     * 
     */
    public com.anychart.graphics.vector.Shape fill(String value) {
