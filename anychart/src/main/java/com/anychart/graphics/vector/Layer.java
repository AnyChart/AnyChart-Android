...
<i>Simplified version of {@link anychart.graphics.vector.Layer#addChildAt} where element is added to the end.</i>
     */
    public com.anychart.graphics.vector.Layer addChild(com.anychart.graphics.vector.Element element) {
...
<img src='/si/8.4.0/anychart.graphics.vector.Layer.addChildAt.png' width='276' height='130'/>
     ...
     */
    public com.anychart.graphics.vector.Layer appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.anychart.graphics.vector.Layer attr(String key, String value) {
...
Read more at {@link anychart.graphics.vector.Circle}
     ...
     */
    public com.anychart.graphics.vector.Layer clip(com.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.anychart.graphics.vector.Layer clip(String value) {
...
Read more at {@link anychart.graphics.vector.primitives#cross}
     ...
     */
    public com.anychart.graphics.vector.Layer cursor(com.anychart.graphics.vector.Cursor value) {
     ...
     */
    public com.anychart.graphics.vector.Layer desc(String value) {
...
Read more at {@link anychart.graphics.vector.primitives#diamond}
     ...
     */
    public com.anychart.graphics.vector.Layer disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.anychart.graphics.vector.Layer disableStrokeScaling(Boolean value) {
...
Read more at {@link anychart.graphics.vector.primitives#donut}
     ...
     */
    public com.anychart.graphics.vector.Layer drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.anychart.graphics.vector.Layer drag(com.anychart.graphics.math.Rect value) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.anychart.graphics.vector.Layer getChildAt(Number index) {
...
You have to take care of used objects yourself.
     ...
     */
    public com.anychart.graphics.vector.Layer remove() {
...
<i>This is an extension of {@link anychart.graphics.vector.Layer#removeChildAt} method.</i>
     */
    public com.anychart.graphics.vector.Layer removeChild(com.anychart.graphics.vector.Element element) {
...
<b>Note:</b> this method doesn't remove element, it just breaks the link between the element and the layer.<br/>
     */
    public com.anychart.graphics.vector.Layer removeChildAt(Number index) {
     ...
     */
    public com.anychart.graphics.vector.Layer rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.anychart.graphics.vector.Layer rotateByAnchor(Number degrees, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Layer rotateByAnchor(Number degrees, String anchor) {
...
Read more at {@link anychart.graphics.vector.primitives#roundedRect}
     ...
     */
    public com.anychart.graphics.vector.Layer scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.anychart.graphics.vector.Layer scaleByAnchor(Number sx, Number sy, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.anychart.graphics.vector.Layer scaleByAnchor(Number sx, Number sy, String anchor) {
     ...
     */
    public com.anychart.graphics.vector.Layer setPosition(Number x, Number y) {
     ...
     */
    public com.anychart.graphics.vector.Layer setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Layer setRotationByAnchor(Number degrees, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Layer setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.anychart.graphics.vector.Layer setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
...
Read more at {@link anychart.graphics.vector.primitives#star7}
     ...
     * Swaps children.
     */
    public com.anychart.graphics.vector.Layer swapChildren(com.anychart.graphics.vector.Element element1, com.anychart.graphics.vector.Element element2) {
     ...
     */
    public com.anychart.graphics.vector.Layer swapChildrenAt(Number index1, Number index2) {
     ...
     */
    public com.anychart.graphics.vector.Layer title(String value) {
     ...
     */
    public com.anychart.graphics.vector.Layer translate(Number tx, Number ty) {
...
Read more at {@link anychart.graphics.vector.primitives#vLine}
     ...
     */
    public com.anychart.graphics.vector.Layer visible(Boolean isVisible) {
     ...
     */
    public com.anychart.graphics.vector.Layer zIndex(Number value) {
