...
Read more at {@link anychart.graphics.vector.Ellipse}
     ...
     */
    public com.anychart.graphics.vector.HatchFill forEachChild(String callback) {
...
Read more at {@link anychart.graphics.vector.primitives#hLine}
     ...
     */
    public com.anychart.graphics.vector.HatchFill id(String value) {
...
You have to take care of used objects yourself.
     ...
     */
    public com.anychart.graphics.vector.HatchFill parent(com.anychart.graphics.vector.Layer value) {
     ...
     * Adds element to the given layer.
     */
    public com.anychart.graphics.vector.HatchFill parent(com.anychart.graphics.vector.Stage value) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (value != null) ? value.getJsBase() : null));
