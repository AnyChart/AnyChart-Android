...
public class Text extends Element {
     ...
     */
    public com.anychart.graphics.vector.Text appendTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     */
    public com.anychart.graphics.vector.Text attr(String key, String value) {
     ...
     */
    public com.anychart.graphics.vector.Text clip(com.anychart.graphics.math.Rect value) {
     ...
     * Sets the clipping rectangle.
     */
    public com.anychart.graphics.vector.Text clip(String value) {
     ...
     */
    public com.anychart.graphics.vector.Text color(String color) {
     ...
     */
    public com.anychart.graphics.vector.Text cursor(com.anychart.graphics.vector.Cursor value) {
     ...
     */
    public com.anychart.graphics.vector.Text decoration(com.anychart.graphics.vector.text.Decoration value) {
     ...
     * Setter for text decoration.
     */
    public com.anychart.graphics.vector.Text decoration(String value) {
     ...
     */
    public com.anychart.graphics.vector.Text desc(String value) {
     ...
     */
    public com.anychart.graphics.vector.Text direction(com.anychart.graphics.vector.text.Direction direction) {
     ...
     * Setter for text direction.
     */
    public com.anychart.graphics.vector.Text direction(String direction) {
     ...
     */
    public com.anychart.graphics.vector.Text disablePointerEvents(Boolean value) {
...
Learn more by <a href="https://www.w3.org/TR/2004/WD-SVG12-20041027/vectoreffects.html#vector-effect-prop">link</a>.
     */
    public com.anychart.graphics.vector.Text disableStrokeScaling(Boolean value) {
...
In case of Stage in Suspended state or unbound element - null is returned.
     ...
     */
    public com.anychart.graphics.vector.Text drag(Boolean value) {
     ...
     * Turns off/on dragging (moving) of an element.
     */
    public com.anychart.graphics.vector.Text drag(com.anychart.graphics.math.Rect value) {
     ...
     */
    public com.anychart.graphics.vector.Text fontFamily(String family) {
     ...
     */
    public com.anychart.graphics.vector.Text fontSize(String size) {
     ...
     * Setter for font size of text.
     */
    public com.anychart.graphics.vector.Text fontSize(Number size) {
     ...
     */
    public com.anychart.graphics.vector.Text fontStyle(com.anychart.graphics.vector.text.FontStyle style) {
     ...
     * Setter for font style of text.
     */
    public com.anychart.graphics.vector.Text fontStyle(String style) {
     ...
     */
    public com.anychart.graphics.vector.Text fontVariant(com.anychart.graphics.vector.text.FontVariant value) {
     ...
     * Setter for font variant of text.
     */
    public com.anychart.graphics.vector.Text fontVariant(String value) {
     ...
     */
    public com.anychart.graphics.vector.Text fontWeight(String weight) {
     ...
     * Setter for font weight of text.
     */
    public com.anychart.graphics.vector.Text fontWeight(Number weight) {
...
See illustrations at {@link anychart.graphics.vector.Element#getAbsoluteWidth}
     ...
     */
    public com.anychart.graphics.vector.Text hAlign(com.anychart.graphics.vector.text.HAlign align) {
     ...
     * Setter for horizontal align of text.
     */
    public com.anychart.graphics.vector.Text hAlign(String align) {
...
<b>Note:</b> it is not calculated automatically and has no default, and if it was not set using setter - <b>NaN</b> is returned.
     ...
     * Sets a height.
     */
    public com.anychart.graphics.vector.Text height(Number height) {
     ...
     * Sets a height.
     */
    public com.anychart.graphics.vector.Text height(String height) {
     ...
     */
    public com.anychart.graphics.vector.Text htmlText(String value) {
     ...
     */
    public com.anychart.graphics.vector.Text id(String id) {
     ...
     */
    public com.anychart.graphics.vector.Text letterSpacing(String spacing) {
     ...
     * Setter for letter spacing of text.
     */
    public com.anychart.graphics.vector.Text letterSpacing(Number spacing) {
     ...
     */
    public com.anychart.graphics.vector.Text lineHeight(String height) {
     ...
     * Sets line height, either as ratio or in pixels.
     */
    public com.anychart.graphics.vector.Text lineHeight(Number height) {
     ...
     */
    public com.anychart.graphics.vector.Text opacity(Number opacity) {
     ...
     */
    public com.anychart.graphics.vector.Text parent(com.anychart.graphics.vector.Layer parent) {
     ...
     * Adds element to the given layer.
     */
    public com.anychart.graphics.vector.Text parent(com.anychart.graphics.vector.Stage parent) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".parent(%s);", (parent != null) ? parent.getJsBase() : null));
     ...
     */
    public com.anychart.graphics.vector.Text path(com.anychart.graphics.vector.Path path) {
     ...
     */
    public com.anychart.graphics.vector.Text remove() {
     ...
     */
    public com.anychart.graphics.vector.Text rotate(Number degrees, Number cx, Number cy) {
     ...
     */
    public com.anychart.graphics.vector.Text rotateByAnchor(Number degrees, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Text rotateByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.anychart.graphics.vector.Text scale(Number sx, Number sy, Number cx, Number cy) {
     ...
     */
    public com.anychart.graphics.vector.Text scaleByAnchor(Number sx, Number sy, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Scales a shape by anchor. Scaling center is set as an anchor.
     */
    public com.anychart.graphics.vector.Text scaleByAnchor(Number sx, Number sy, String anchor) {
...
Defines whether text can be selected. If <b>false</b> - no selection.
     */
    public com.anychart.graphics.vector.Text selectable(Boolean enabled) {
     ...
     */
    public com.anychart.graphics.vector.Text setPosition(Number x, Number y) {
     ...
     */
    public com.anychart.graphics.vector.Text setRotation(Number degrees, Number cx, Number cy) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Text setRotationByAnchor(Number degrees, com.anychart.graphics.vector.Anchor anchor) {
     ...
     * Rotates a shape around the given anchor.
     */
    public com.anychart.graphics.vector.Text setRotationByAnchor(Number degrees, String anchor) {
     ...
     */
    public com.anychart.graphics.vector.Text setTransformationMatrix(Number m00, Number m10, Number m01, Number m11, Number m02, Number m12) {
     ...
     * Setter for the text.
     */
    public com.anychart.graphics.vector.Text text(String text) {
...
The text-indent property specifies the indentation of the first line in a text-block.
     */
    public com.anychart.graphics.vector.Text textIndent(Number indent) {
     ...
     */
    public com.anychart.graphics.vector.Text textOverflow(com.anychart.graphics.vector.text.TextOverflow value) {
     ...
     * Setter for the text overflow mode.
     */
    public com.anychart.graphics.vector.Text textOverflow(String value) {
     ...
     */
    public com.anychart.graphics.vector.Text title(String value) {
     ...
     */
    public com.anychart.graphics.vector.Text translate(Number tx, Number ty) {
     ...
     */
    public com.anychart.graphics.vector.Text vAlign(com.anychart.graphics.vector.text.VAlign align) {
     ...
     * Setter for vertical align of text.
     */
    public com.anychart.graphics.vector.Text vAlign(String align) {
     ...
     */
    public com.anychart.graphics.vector.Text visible(Boolean isVisible) {
...
<b>Note:</b> it is not calculated automatically and has no default, and if it  was not set using setter - <b>NaN</b> is returned.
     ...
     * Sets a width.
     */
    public com.anychart.graphics.vector.Text width(Number width) {
     ...
     * Sets a width.
     */
    public com.anychart.graphics.vector.Text width(String width) {
...
More at: <a href='https://www.w3schools.com/cssref/css3_pr_word-break.asp'>Word-break Property</a>
     ...
     */
    public com.anychart.graphics.vector.Text wordBreak(String value) {
     ...
     * Setter for word break of text.
     */
    public com.anychart.graphics.vector.Text wordBreak(com.anychart.graphics.vector.text.WordBreak value) {
...
More at: <a href='https://www.w3schools.com/cssref/css3_pr_word-wrap.asp'>Word-wrap Property</a>
     ...
     */
    public com.anychart.graphics.vector.Text x(Number xCoord) {
     ...
     */
    public com.anychart.graphics.vector.Text y(Number yCoord) {
     ...
     */
    public com.anychart.graphics.vector.Text zIndex(Number value) {
