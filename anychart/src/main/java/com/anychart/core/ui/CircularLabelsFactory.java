...
public class CircularLabelsFactory extends LabelsFactory {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory adjustFontSize(String settings) {
     ...
     * Setter for the adjusting font size by one parameter.
     */
    public com.anychart.core.ui.CircularLabelsFactory adjustFontSize(Boolean[] settings) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory anchor(com.anychart.enums.Anchor anchor) {
     ...
     * Setter for the labels anchor settings.
     */
    public com.anychart.core.ui.CircularLabelsFactory anchor(String anchor) {
...
Auto rotates the labels around an anchor.
     */
    public com.anychart.core.ui.CircularLabelsFactory autoRotate(Boolean enabled) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".autoRotate(%s);", enabled));
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory background(String settings) {
     ...
     * Setter for the labels background settings.
     */
    public com.anychart.core.ui.CircularLabelsFactory background(Boolean settings) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory disablePointerEvents(Boolean enabled) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory enabled(Boolean enabled) {
...
{@link https://www.w3schools.com/html/html_colors.asp}
     */
    public com.anychart.core.ui.CircularLabelsFactory fontColor(String color) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory fontFamily(String family) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory fontOpacity(Number opacity) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory fontSize(String size) {
     ...
     * Setter for the text font size.
     */
    public com.anychart.core.ui.CircularLabelsFactory fontSize(Number size) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory fontStyle(com.anychart.graphics.vector.text.FontStyle style) {
     ...
     * Setter for the text font style.
     */
    public com.anychart.core.ui.CircularLabelsFactory fontStyle(String style) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.anychart.core.ui.CircularLabelsFactory fontWeight(String weight) {
...
{@link https://www.w3schools.com/cssref/pr_font_weight.asp}
     */
    public com.anychart.core.ui.CircularLabelsFactory fontWeight(Number weight) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory hAlign(com.anychart.graphics.vector.text.HAlign align) {
     ...
     * Setter for the text horizontal align.
     */
    public com.anychart.core.ui.CircularLabelsFactory hAlign(String align) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory height(Number height) {
     ...
     * Setter for labels height settings.
     */
    public com.anychart.core.ui.CircularLabelsFactory height(String height) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.anychart.core.ui.CircularLabelsFactory letterSpacing(String spacing) {
...
{@link https://www.w3schools.com/cssref/pr_text_letter-spacing.asp}
     */
    public com.anychart.core.ui.CircularLabelsFactory letterSpacing(Number spacing) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.anychart.core.ui.CircularLabelsFactory lineHeight(String height) {
...
{@link https://www.w3schools.com/cssref/pr_dim_line-height.asp}
     */
    public com.anychart.core.ui.CircularLabelsFactory lineHeight(Number height) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory maxFontSize(Number size) {
     ...
     * Setter for maximum font size settings for adjust text to.
     */
    public com.anychart.core.ui.CircularLabelsFactory maxFontSize(String size) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory minFontSize(Number size) {
     ...
     * Setter for the minimum font size settings for adjust text from.
     */
    public com.anychart.core.ui.CircularLabelsFactory minFontSize(String size) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory offsetX(Number offset) {
     ...
     * Setter for the labels offsetX settings.
     */
    public com.anychart.core.ui.CircularLabelsFactory offsetX(String offset) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory offsetY(Number offset) {
     ...
     * Setter for the labels offsetY settings.
     */
    public com.anychart.core.ui.CircularLabelsFactory offsetY(String offset) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory padding(Number[] padding) {
     ...
     * Setter for labels padding in pixels using a single value.
     */
    public com.anychart.core.ui.CircularLabelsFactory padding(String[] padding) {
...
Find more information in the detailed description.
     */
    public com.anychart.core.ui.CircularLabelsFactory position(String position) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory positionFormatter(String formatter) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory rotation(Number angle) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory selectable(Boolean enabled) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory textDirection(com.anychart.graphics.vector.text.Direction direction) {
     ...
     * Setter for the text direction.
     */
    public com.anychart.core.ui.CircularLabelsFactory textDirection(String direction) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory textIndent(Number indent) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory textSettings(String name, String settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.anychart.core.ui.CircularLabelsFactory textSettings(String name, Number settings) {
     ...
     * Setter for the text appearance settings.
     */
    public com.anychart.core.ui.CircularLabelsFactory textSettings(String name, Boolean settings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".textSettings(%s, %s);", wrapQuotes(name), settings));
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory useHtml(Boolean enabled) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory vAlign(com.anychart.graphics.vector.text.VAlign align) {
     ...
     * Setter for the text vertical align.
     */
    public com.anychart.core.ui.CircularLabelsFactory vAlign(String align) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory width(Number width) {
     ...
     * Setter for labels width settings.
     */
    public com.anychart.core.ui.CircularLabelsFactory width(String width) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory wordBreak(com.anychart.enums.WordBreak mode) {
     ...
     * Setter for the word-break mode.
     */
    public com.anychart.core.ui.CircularLabelsFactory wordBreak(String mode) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory wordWrap(com.anychart.enums.WordWrap mode) {
     ...
     * Setter for the word-wrap mode.
     */
    public com.anychart.core.ui.CircularLabelsFactory wordWrap(String mode) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory zIndex(Number zIndex) {
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory connectorStroke(String settings) {
...
{docs:Common_Settings/Text_Formatters}Learn more about using the format() method.{docs}
     ...
     */
    public com.anychart.core.ui.CircularLabelsFactory container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.anychart.core.ui.CircularLabelsFactory container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.anychart.core.ui.CircularLabelsFactory container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.ui.CircularLabelsFactory parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.ui.CircularLabelsFactory parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.ui.CircularLabelsFactory parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.ui.CircularLabelsFactory parentBounds(Number left, Number top, Number width, Number height) {
