...
public class Stock extends Base {
     ...
     */
    public com.anychart.core.series.Stock bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.core.series.Stock bottom(String bottom) {
     ...
     */
    public com.anychart.core.series.Stock bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.series.Stock bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.series.Stock bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.core.series.Stock enabled(Boolean enabled) {
     ...
     */
    public com.anychart.core.series.Stock height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.core.series.Stock height(String height) {
     ...
     */
    public com.anychart.core.series.Stock left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.core.series.Stock left(String left) {
     ...
     */
    public com.anychart.core.series.Stock maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.core.series.Stock maxHeight(String height) {
     ...
     */
    public com.anychart.core.series.Stock maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.core.series.Stock maxWidth(String width) {
     ...
     */
    public com.anychart.core.series.Stock minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.core.series.Stock minHeight(String height) {
     ...
     */
    public com.anychart.core.series.Stock minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.core.series.Stock minWidth(String width) {
     ...
     */
    public com.anychart.core.series.Stock right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.core.series.Stock right(String right) {
     ...
     */
    public com.anychart.core.series.Stock top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.core.series.Stock top(String top) {
     ...
     */
    public com.anychart.core.series.Stock width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.core.series.Stock width(String width) {
     ...
     */
    public com.anychart.core.series.Stock zIndex(Number zIndex) {
     ...
     */
    public com.anychart.core.series.Stock container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the container.
     */
    public com.anychart.core.series.Stock container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the container.
     */
    public com.anychart.core.series.Stock container(String element) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.series.Stock parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.series.Stock parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.series.Stock parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.series.Stock parentBounds(Number left, Number top, Number width, Number height) {
