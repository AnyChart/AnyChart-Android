...
public class Chart extends VisualBaseWithBounds {
     ...
     */
    public com.anychart.core.Chart a11y(Boolean settings) {
     ...
     * Setter for the accessibility setting.
     */
    public com.anychart.core.Chart a11y(String settings) {
     ...
     */
    public com.anychart.core.Chart animation(Boolean settings) {
     ...
     * Setter for animation settings by one value.
     */
    public com.anychart.core.Chart animation(String settings) {
...
Flag whether to automatically call chart.draw() on any changes or not.
     */
    public com.anychart.core.Chart autoRedraw(Boolean enabled) {
     ...
     */
    public com.anychart.core.Chart background(String settings) {
     ...
     */
    public com.anychart.core.Chart bottom(Number bottom) {
     ...
     * Setter for element bottom bound settings.
     */
    public com.anychart.core.Chart bottom(String bottom) {
     ...
     */
    public com.anychart.core.Chart bounds(com.anychart.utils.RectObj bounds) {
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.Chart bounds(com.anychart.math.Rect bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     * Setter for bounds of the element using one parameter.
     */
    public com.anychart.core.Chart bounds(com.anychart.core.utils.Bounds bounds) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".bounds(%s);", (bounds != null) ? bounds.getJsBase() : null));
     ...
     */
    public com.anychart.core.Chart container(com.anychart.graphics.vector.Layer element) {
     ...
     * Setter for the element's container.
     */
    public com.anychart.core.Chart container(com.anychart.graphics.vector.Stage element) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".container(%s);", (element != null) ? element.getJsBase() : null));
     ...
     * Setter for the element's container.
     */
    public com.anychart.core.Chart container(String element) {
     ...
     */
    public com.anychart.core.Chart contextMenu(String settings) {
     ...
     * Setter for the context menu.
     */
    public com.anychart.core.Chart contextMenu(Boolean settings) {
...
{docs:Quick_Start/Credits}Learn more about credits settings.{docs}
     ...
     */
    public com.anychart.core.Chart enabled(Boolean enabled) {
     ...
     */
    public com.anychart.core.Chart exports(String settings) {
     ...
     */
    public com.anychart.core.Chart fullScreen(Boolean enabled) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public com.anychart.core.Chart height(Number height) {
     ...
     * Setter for element height setting.
     */
    public com.anychart.core.Chart height(String height) {
     ...
     * Setter for chart id.
     */
    public com.anychart.core.Chart id(String id) {
     ...
     */
    public com.anychart.core.Chart left(Number left) {
     ...
     * Setter for element left bound settings.
     */
    public com.anychart.core.Chart left(String left) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.margin.png' width='352' height='351'/>
     ...
     */
    public com.anychart.core.Chart margin(Number[] margin) {
     ...
     * Setter for the chart margin in pixels using a single complex object.
     */
    public com.anychart.core.Chart margin(String[] margin) {
     ...
     */
    public com.anychart.core.Chart maxHeight(Number height) {
     ...
     * Setter for the maximum height.
     */
    public com.anychart.core.Chart maxHeight(String height) {
     ...
     */
    public com.anychart.core.Chart maxWidth(Number width) {
     ...
     * Setter for the maximum width.
     */
    public com.anychart.core.Chart maxWidth(String width) {
     ...
     */
    public com.anychart.core.Chart minHeight(Number height) {
     ...
     * Setter for the minimum height.
     */
    public com.anychart.core.Chart minHeight(String height) {
     ...
     */
    public com.anychart.core.Chart minWidth(Number width) {
     ...
     * Setter for the minimum width.
     */
    public com.anychart.core.Chart minWidth(String width) {
...
{docs:Working_with_Data/No_Data_Label} Learn more about "No data" feature {docs}
     */
    public com.anychart.core.Chart noData(String settings) {
...
<img src='/si/8.4.0/anychart.core.Chart.prototype.padding.png' width='352' height='351'/>
     ...
     */
    public com.anychart.core.Chart right(Number right) {
     ...
     * Setter for element right bound setting.
     */
    public com.anychart.core.Chart right(String right) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.Chart selectMarqueeFill(com.anychart.graphics.vector.Fill color) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.Chart selectMarqueeFill(com.anychart.graphics.vector.GradientKey color) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".selectMarqueeFill(%s);", (color != null) ? color.getJsBase() : null));
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.Chart selectMarqueeFill(String[] color) {
...
<b>Note:</b> Works only after {@link anychart.core.Chart#draw} is called.
     ...
     */
    public com.anychart.core.Chart title(Boolean settings) {
     ...
     * Setter for the chart title.
     */
    public com.anychart.core.Chart title(String settings) {
     ...
     */
    public com.anychart.core.Chart tooltip(String settings) {
     ...
     * Setter for the chart tooltip.
     */
    public com.anychart.core.Chart tooltip(Boolean settings) {
     ...
     */
    public com.anychart.core.Chart top(Number top) {
     ...
     * Setter for element top bound settings.
     */
    public com.anychart.core.Chart top(String top) {
     ...
     */
    public com.anychart.core.Chart width(Number width) {
     ...
     * Setter for element width setting.
     */
    public com.anychart.core.Chart width(String width) {
     ...
     */
    public com.anychart.core.Chart zIndex(Number zIndex) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.Chart parentBounds(com.anychart.math.Rect bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.Chart parentBounds(String bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.Chart parentBounds(Number bounds) {
...
Bounds that would be used in case of percent size calculations. Expects pixel values only.
     */
    public com.anychart.core.Chart parentBounds(Number left, Number top, Number width, Number height) {
