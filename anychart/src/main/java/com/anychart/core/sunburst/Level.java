...
public class Level extends Base {
    ...
    public Level(String jsChart) {
        jsBase = "level" + ++variableIndex;
     ...
     */
    public com.anychart.core.sunburst.Level enabled(Boolean enabled) {
     ...
     */
    public com.anychart.core.sunburst.Level hovered(String settings) {
     ...
     */
    public com.anychart.core.sunburst.Level labels(String settings) {
     ...
     * Setter for the labels settings.
     */
    public com.anychart.core.sunburst.Level labels(Boolean settings) {
     ...
     */
    public com.anychart.core.sunburst.Level normal(String settings) {
     ...
     */
    public com.anychart.core.sunburst.Level selected(String settings) {
    ...
    public void thickness() {
        APIlib.getInstance().addJSLine(jsBase + ".thickness();");
    }
    /**
     * Setter for the level thickness.
     */
    public com.anychart.core.sunburst.Level thickness(String thickness) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".thickness(%s);", wrapQuotes(thickness)));
     ...
     * Setter for the level thickness.
     */
    public com.anychart.core.sunburst.Level thickness(Number thickness) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".thickness(%s);", thickness));
