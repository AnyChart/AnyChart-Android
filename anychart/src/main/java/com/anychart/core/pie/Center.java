...
public class Center extends Base {
    ...
    public static Center instantiate() {
        return new Center("new anychart.core.pie.center()");
    }
     ...
     */
    public com.anychart.core.pie.Center content(com.anychart.graphics.vector.Element contentSettings) {
     ...
     * Setter for the center content.
     */
    public com.anychart.core.pie.Center content(com.anychart.core.VisualBase contentSettings) {
        APIlib.getInstance().addJSLine(String.format(Locale.US, jsBase + ".content(%s);", (contentSettings != null) ? contentSettings.getJsBase() : null));
     ...
     * Setter for the center content.
     */
    public com.anychart.core.pie.Center content(String contentSettings) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(com.anychart.graphics.vector.Fill value) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(String value) {
     ...
     */
    public com.anychart.core.pie.Center fill(String color, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(com.anychart.graphics.vector.GradientKey keys, Number angle, Boolean mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(com.anychart.graphics.vector.GradientKey keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(com.anychart.graphics.vector.GradientKey keys, Number angle, String mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(String[] keys, Number angle, Boolean mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(String[] keys, Number angle, com.anychart.graphics.vector.Rect mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(String[] keys, Number angle, String mode, Number opacity) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(com.anychart.graphics.vector.GradientKey keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
{docs:Graphics/Fill_Settings}Learn more about coloring.{docs}
     */
    public com.anychart.core.pie.Center fill(String[] keys, Number cx, Number cy, com.anychart.graphics.math.Rect mode, Number opacity, Number fx, Number fy) {
...
{docs:Graphics/Stroke_Settings}Learn more about stroke settings.{docs}
     ...
     * 
     */
    public com.anychart.core.map.series.Base stroke(String value) {
        return new com.anychart.core.map.series.Base(String.format(Locale.US, jsBase + ".stroke(%s)", wrapQuotes(value)));
    }
